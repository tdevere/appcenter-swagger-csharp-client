...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class TestCloudToolsetProjects :  IEquatable<TestCloudToolsetProjects>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="TestCloudToolsetProjects" /> class.
        /// </summary>
        ...
        public TestCloudToolsetProjects(string path = default(string), FrameworkTypeEnum frameworkType = default(FrameworkTypeEnum), TestCloudToolsetFrameworkProperties frameworkProperties = default(TestCloudToolsetFrameworkProperties))
        {
            // to ensure "path" is required (not null)
            if (path == null)
            {
                throw new InvalidDataException("path is a required property for TestCloudToolsetProjects and cannot be null");
            }
            else
            {
                this.Path = path;
            ...
            {
                throw new InvalidDataException("frameworkType is a required property for TestCloudToolsetProjects and cannot be null");
            }
            else
            {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TestCloudToolsetProjects {\n");
        ...
        {
            return this.Equals(input as TestCloudToolsetProjects);
        }

        /// <summary>
        /// Returns true if TestCloudToolsetProjects instances are equal
        /// </summary>
        /// <param name="input">Instance of TestCloudToolsetProjects to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TestCloudToolsetProjects input)
        {
            if (input == null)
                return false;
