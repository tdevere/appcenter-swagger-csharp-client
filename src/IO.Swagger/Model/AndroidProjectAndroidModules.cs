...
{
    /// <summary>
    /// AndroidProjectAndroidModules
    /// </summary>
    [DataContract]
        public partial class AndroidProjectAndroidModules :  IEquatable<AndroidProjectAndroidModules>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="AndroidProjectAndroidModules" /> class.
        /// </summary>
        ...
        public AndroidProjectAndroidModules(string name = default(string), bool? hasBundle = default(bool?), List<string> productFlavors = default(List<string>), List<string> buildVariants = default(List<string>), List<string> buildTypes = default(List<string>), List<AndroidProjectBuildConfigurations> buildConfigurations = default(List<AndroidProjectBuildConfigurations>), bool? isRoot = default(bool?))
        {
            // to ensure "name" is required (not null)
            if (name == null)
            {
                throw new InvalidDataException("name is a required property for AndroidProjectAndroidModules and cannot be null");
            }
            else
            {
                this.Name = name;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class AndroidProjectAndroidModules {\n");
        ...
        {
            return this.Equals(input as AndroidProjectAndroidModules);
        }

        /// <summary>
        /// Returns true if AndroidProjectAndroidModules instances are equal
        /// </summary>
        /// <param name="input">Instance of AndroidProjectAndroidModules to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AndroidProjectAndroidModules input)
        {
            if (input == null)
                return false;
