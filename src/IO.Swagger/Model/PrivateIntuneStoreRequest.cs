...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class PrivateIntuneStoreRequest :  IEquatable<PrivateIntuneStoreRequest>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PrivateIntuneStoreRequest" /> class.
        /// </summary>
        ...
        {
            return this.Equals(input as PrivateIntuneStoreRequest);
        }

        /// <summary>
        /// Returns true if PrivateIntuneStoreRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of PrivateIntuneStoreRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PrivateIntuneStoreRequest input)
        {
            if (input == null)
                return false;
