...
namespace IO.Swagger.Model
{
        ...
        public partial class InlineResponse20010 :  IEquatable<InlineResponse20010>, IValidatableObject
    {
        ...
        public InlineResponse20010(string code = default(string), bool? invitePending = default(bool?), string message = default(string), int? status = default(int?), string userEmail = default(string))
        {
            // to ensure "status" is required (not null)
            if (status == null)
            {
                throw new InvalidDataException("status is a required property for InlineResponse20010 and cannot be null");
            }
            else
            {
                this.Status = status;
