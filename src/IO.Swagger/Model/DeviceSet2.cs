...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class DeviceSet2 :  IEquatable<DeviceSet2>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="DeviceSet2" /> class.
        /// </summary>
        ...
        public DeviceSet2(string id = default(string), decimal? manufacturerCount = default(decimal?), string name = default(string), string slug = default(string), DeviceSetOwner owner = default(DeviceSetOwner), decimal? osVersionCount = default(decimal?), List<V01appsownerNameappNameownerdeviceSetsDeviceConfigurations> deviceConfigurations = default(List<V01appsownerNameappNameownerdeviceSetsDeviceConfigurations>))
        {
            // to ensure "id" is required (not null)
            if (id == null)
            {
                throw new InvalidDataException("id is a required property for DeviceSet2 and cannot be null");
            }
            else
            {
                this.Id = id;
            ...
            if (name == null)
            {
                throw new InvalidDataException("name is a required property for DeviceSet2 and cannot be null");
            }
            else
            {
                this.Name = name;
            ...
            if (owner == null)
            {
                throw new InvalidDataException("owner is a required property for DeviceSet2 and cannot be null");
            }
            else
            {
                this.Owner = owner;
            ...
            {
                throw new InvalidDataException("deviceConfigurations is a required property for DeviceSet2 and cannot be null");
            }
            else
            {
        ...
        public List<V01appsownerNameappNameownerdeviceSetsDeviceConfigurations> DeviceConfigurations { get; set; }
        ...
        {
            return this.Equals(input as DeviceSet2);
        }

        /// <summary>
        /// Returns true if DeviceSet2 instances are equal
        /// </summary>
        /// <param name="input">Instance of DeviceSet2 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(DeviceSet2 input)
        {
            if (input == null)
                return false;
