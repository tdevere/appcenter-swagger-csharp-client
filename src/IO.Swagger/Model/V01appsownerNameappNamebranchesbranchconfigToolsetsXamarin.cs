...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class V01appsownerNameappNamebranchesbranchconfigToolsetsXamarin :  IEquatable<V01appsownerNameappNamebranchesbranchconfigToolsetsXamarin>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="V01appsownerNameappNamebranchesbranchconfigToolsetsXamarin" /> class.
        /// </summary>
        ...
        public V01appsownerNameappNamebranchesbranchconfigToolsetsXamarin(string slnPath = default(string), bool? isSimBuild = default(bool?), string args = default(string), string configuration = default(string), string p12File = default(string), string p12Pwd = default(string), string provProfile = default(string), string monoVersion = default(string), string sdkBundle = default(string), string symlink = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class V01appsownerNameappNamebranchesbranchconfigToolsetsXamarin {\n");
        ...
        {
            return this.Equals(input as V01appsownerNameappNamebranchesbranchconfigToolsetsXamarin);
        }

        /// <summary>
        /// Returns true if V01appsownerNameappNamebranchesbranchconfigToolsetsXamarin instances are equal
        /// </summary>
        /// <param name="input">Instance of V01appsownerNameappNamebranchesbranchconfigToolsetsXamarin to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(V01appsownerNameappNamebranchesbranchconfigToolsetsXamarin input)
        {
            if (input == null)
                return false;
