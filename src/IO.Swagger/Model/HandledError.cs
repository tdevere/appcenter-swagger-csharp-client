...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class HandledError :  IEquatable<HandledError>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="HandledError" /> class.
        /// </summary>
        ...
        {
            return this.Equals(input as HandledError);
        }

        /// <summary>
        /// Returns true if HandledError instances are equal
        /// </summary>
        /// <param name="input">Instance of HandledError to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(HandledError input)
        {
            if (input == null)
                return false;
