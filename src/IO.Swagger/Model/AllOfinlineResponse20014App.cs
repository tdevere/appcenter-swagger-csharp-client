...
{
    /// <summary>
    /// AllOfinlineResponse20014App
    /// </summary>
    [DataContract]
        public partial class AllOfinlineResponse20014App :  IEquatable<AllOfinlineResponse20014App>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="AllOfinlineResponse20014App" /> class.
        /// </summary>
        ...
        public AllOfinlineResponse20014App(string appSecret = default(string), Object azureSubscription = default(Object), PlatformEnum? platform = default(PlatformEnum?), OriginEnum? origin = default(OriginEnum?), string createdAt = default(string), string updatedAt = default(string), List<MemberPermissionsEnum> memberPermissions = default(List<MemberPermissionsEnum>))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class AllOfinlineResponse20014App {\n");
        ...
        {
            return this.Equals(input as AllOfinlineResponse20014App);
        }

        /// <summary>
        /// Returns true if AllOfinlineResponse20014App instances are equal
        /// </summary>
        /// <param name="input">Instance of AllOfinlineResponse20014App to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AllOfinlineResponse20014App input)
        {
            if (input == null)
                return false;
