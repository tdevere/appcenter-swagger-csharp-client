...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class AppleTestFlightGroupRequest :  IEquatable<AppleTestFlightGroupRequest>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="AppleTestFlightGroupRequest" /> class.
        /// </summary>
        ...
        /// <param name="appleId">apple_id of the app for which test flight groups need to be fetched..</param>
        /// <param name="bundleIdentifier">apple_id of the app for which test flight groups need to be fetched..</param>
        ...
        /// </summary>
        /// <value>apple_id of the app for which test flight groups need to be fetched.</value>
        ...
        {
            return this.Equals(input as AppleTestFlightGroupRequest);
        }

        /// <summary>
        /// Returns true if AppleTestFlightGroupRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of AppleTestFlightGroupRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AppleTestFlightGroupRequest input)
        {
            if (input == null)
                return false;
