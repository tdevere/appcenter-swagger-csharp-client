...
namespace IO.Swagger.Model
{
        ...
        public partial class OrganizationResponse :  IEquatable<OrganizationResponse>, IValidatableObject
    {
        ...
        public OrganizationResponse(Guid? id = default(Guid?), string displayName = default(string), string name = default(string), string avatarUrl = default(string), OriginEnum origin = default(OriginEnum), string createdAt = default(string), string updatedAt = default(string))
        {
            // to ensure "id" is required (not null)
            if (id == null)
            {
                throw new InvalidDataException("id is a required property for OrganizationResponse and cannot be null");
            }
            else
            {
                this.Id = id;
            ...
            if (displayName == null)
            {
                throw new InvalidDataException("displayName is a required property for OrganizationResponse and cannot be null");
            }
            else
            {
            ...
            if (name == null)
            {
                throw new InvalidDataException("name is a required property for OrganizationResponse and cannot be null");
            }
            else
            {
                this.Name = name;
            ...
            if (origin == null)
            {
                throw new InvalidDataException("origin is a required property for OrganizationResponse and cannot be null");
            }
            else
            {
                this.Origin = origin;
            ...
            if (createdAt == null)
            {
                throw new InvalidDataException("createdAt is a required property for OrganizationResponse and cannot be null");
            }
            else
            {
            ...
            if (updatedAt == null)
            {
                throw new InvalidDataException("updatedAt is a required property for OrganizationResponse and cannot be null");
            }
            else
            {
        ...
        {
            return this.Equals(input as OrganizationResponse);
        }

        /// <summary>
        /// Returns true if OrganizationResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of OrganizationResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(OrganizationResponse input)
        {
            if (input == null)
                return false;
