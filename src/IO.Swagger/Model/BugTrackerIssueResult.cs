...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class BugTrackerIssueResult :  IEquatable<BugTrackerIssueResult>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="BugTrackerIssueResult" /> class.
        /// </summary>
        ...
        public BugTrackerIssueResult(string id = default(string), string url = default(string), string title = default(string), BugTrackerTypeEnum? bugTrackerType = default(BugTrackerTypeEnum?), string repoName = default(string), string mobileCenterId = default(string), string eventType = default(string))
        {
            this.Id = id;
            this.Url = url;
            this.Title = title;
        ...
        {
            return this.Equals(input as BugTrackerIssueResult);
        }

        /// <summary>
        /// Returns true if BugTrackerIssueResult instances are equal
        /// </summary>
        /// <param name="input">Instance of BugTrackerIssueResult to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(BugTrackerIssueResult input)
        {
            if (input == null)
                return false;
