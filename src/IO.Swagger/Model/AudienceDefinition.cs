...
namespace IO.Swagger.Model
{
        ...
        public partial class AudienceDefinition :  IEquatable<AudienceDefinition>, IValidatableObject
    {
        ...
        public AudienceDefinition(string description = default(string), string definition = default(string), bool? enabled = true, Dictionary<string, InnerEnum> customProperties = default(Dictionary<string, InnerEnum>))
        {
            // to ensure "definition" is required (not null)
            if (definition == null)
            {
                throw new InvalidDataException("definition is a required property for AudienceDefinition and cannot be null");
            }
            else
            {
