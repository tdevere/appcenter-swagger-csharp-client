...
{
    /// <summary>
    /// AllOfLegacyUpdateCheckResponseUpdateInfo
    /// </summary>
    [DataContract]
        public partial class AllOfLegacyUpdateCheckResponseUpdateInfo :  IEquatable<AllOfLegacyUpdateCheckResponseUpdateInfo>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="AllOfLegacyUpdateCheckResponseUpdateInfo" /> class.
        /// </summary>
        ...
        public AllOfLegacyUpdateCheckResponseUpdateInfo(string downloadURL = default(string), bool? isAvailable = default(bool?), decimal? packageSize = default(decimal?), bool? shouldRunBinaryVersion = default(bool?), bool? updateAppVersion = default(bool?), string packageHash = default(string), string label = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class AllOfLegacyUpdateCheckResponseUpdateInfo {\n");
        ...
        {
            return this.Equals(input as AllOfLegacyUpdateCheckResponseUpdateInfo);
        }

        /// <summary>
        /// Returns true if AllOfLegacyUpdateCheckResponseUpdateInfo instances are equal
        /// </summary>
        /// <param name="input">Instance of AllOfLegacyUpdateCheckResponseUpdateInfo to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AllOfLegacyUpdateCheckResponseUpdateInfo input)
        {
            if (input == null)
                return false;
