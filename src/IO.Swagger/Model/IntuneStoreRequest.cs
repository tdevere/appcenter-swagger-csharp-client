...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class IntuneStoreRequest :  IEquatable<IntuneStoreRequest>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="IntuneStoreRequest" /> class.
        /// </summary>
        ...
        {
            return this.Equals(input as IntuneStoreRequest);
        }

        /// <summary>
        /// Returns true if IntuneStoreRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of IntuneStoreRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(IntuneStoreRequest input)
        {
            if (input == null)
                return false;
