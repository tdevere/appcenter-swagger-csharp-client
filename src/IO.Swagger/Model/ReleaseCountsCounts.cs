...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class ReleaseCountsCounts :  IEquatable<ReleaseCountsCounts>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ReleaseCountsCounts" /> class.
        /// </summary>
        ...
        public ReleaseCountsCounts(string releaseId = default(string), string distributionGroup = default(string), long? uniqueCount = default(long?), long? totalCount = default(long?))
        {
            // to ensure "releaseId" is required (not null)
            if (releaseId == null)
            {
                throw new InvalidDataException("releaseId is a required property for ReleaseCountsCounts and cannot be null");
            }
            else
            {
            ...
            if (uniqueCount == null)
            {
                throw new InvalidDataException("uniqueCount is a required property for ReleaseCountsCounts and cannot be null");
            }
            else
            {
            ...
            if (totalCount == null)
            {
                throw new InvalidDataException("totalCount is a required property for ReleaseCountsCounts and cannot be null");
            }
            else
            {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ReleaseCountsCounts {\n");
        ...
        {
            return this.Equals(input as ReleaseCountsCounts);
        }

        /// <summary>
        /// Returns true if ReleaseCountsCounts instances are equal
        /// </summary>
        /// <param name="input">Instance of ReleaseCountsCounts to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ReleaseCountsCounts input)
        {
            if (input == null)
                return false;
