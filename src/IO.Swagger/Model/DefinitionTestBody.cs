...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class DefinitionTestBody :  IEquatable<DefinitionTestBody>, IValidatableObject
    {
        /// <summary>
        /// Defines Inner
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="DefinitionTestBody" /> class.
        /// </summary>
        ...
        public DefinitionTestBody(string description = default(string), string definition = default(string), bool? enabled = true, Dictionary<string, InnerEnum> customProperties = default(Dictionary<string, InnerEnum>))
        {
            // to ensure "definition" is required (not null)
            if (definition == null)
            {
                throw new InvalidDataException("definition is a required property for DefinitionTestBody and cannot be null");
            }
            else
            {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class DefinitionTestBody {\n");
        ...
        {
            return this.Equals(input as DefinitionTestBody);
        }

        /// <summary>
        /// Returns true if DefinitionTestBody instances are equal
        /// </summary>
        /// <param name="input">Instance of DefinitionTestBody to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(DefinitionTestBody input)
        {
            if (input == null)
                return false;
