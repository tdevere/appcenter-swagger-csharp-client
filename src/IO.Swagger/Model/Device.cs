...
namespace IO.Swagger.Model
{
        ...
        public partial class Device :  IEquatable<Device>, IValidatableObject
    {
        ...
        public Device(string sdkName = default(string), string sdkVersion = default(string), string wrapperSdkVersion = default(string), string wrapperSdkName = default(string), string model = default(string), string oemName = default(string), string osName = default(string), string osVersion = default(string), string osBuild = default(string), int? osApiLevel = default(int?), string locale = default(string), int? timeZoneOffset = default(int?), string screenSize = default(string), string appVersion = default(string), string carrierName = default(string), string carrierCode = default(string), string carrierCountry = default(string), string appBuild = default(string), string appNamespace = default(string), string liveUpdateReleaseLabel = default(string), string liveUpdateDeploymentKey = default(string), string liveUpdatePackageHash = default(string), string wrapperRuntimeVersion = default(string))
        {
            ...
            if (sdkVersion == null)
            {
                throw new InvalidDataException("sdkVersion is a required property for Device and cannot be null");
            }
            else
            {
            ...
            if (osName == null)
            {
                throw new InvalidDataException("osName is a required property for Device and cannot be null");
            }
            else
            {
                this.OsName = osName;
            ...
            if (osVersion == null)
            {
                throw new InvalidDataException("osVersion is a required property for Device and cannot be null");
            }
            else
            {
            ...
            if (locale == null)
            {
                throw new InvalidDataException("locale is a required property for Device and cannot be null");
            }
            else
            {
                this.Locale = locale;
            ...
            {
                throw new InvalidDataException("timeZoneOffset is a required property for Device and cannot be null");
            }
            else
            {
            ...
            if (appVersion == null)
            {
                throw new InvalidDataException("appVersion is a required property for Device and cannot be null");
            }
            else
            {
            ...
            if (appBuild == null)
            {
                throw new InvalidDataException("appBuild is a required property for Device and cannot be null");
            }
            else
            {
