...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class JavaScriptBranchConfigurationProperties :  IEquatable<JavaScriptBranchConfigurationProperties>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="JavaScriptBranchConfigurationProperties" /> class.
        /// </summary>
        ...
        public JavaScriptBranchConfigurationProperties(string packageJsonPath = default(string), bool? runTests = default(bool?), string reactNativeVersion = default(string))
        {
        ...
        {
            return this.Equals(input as JavaScriptBranchConfigurationProperties);
        }

        /// <summary>
        /// Returns true if JavaScriptBranchConfigurationProperties instances are equal
        /// </summary>
        /// <param name="input">Instance of JavaScriptBranchConfigurationProperties to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(JavaScriptBranchConfigurationProperties input)
        {
            if (input == null)
                return false;
