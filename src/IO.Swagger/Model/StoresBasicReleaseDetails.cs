...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class StoresBasicReleaseDetails :  IEquatable<StoresBasicReleaseDetails>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="StoresBasicReleaseDetails" /> class.
        /// </summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class StoresBasicReleaseDetails {\n");
        ...
        {
            return this.Equals(input as StoresBasicReleaseDetails);
        }

        /// <summary>
        /// Returns true if StoresBasicReleaseDetails instances are equal
        /// </summary>
        /// <param name="input">Instance of StoresBasicReleaseDetails to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(StoresBasicReleaseDetails input)
        {
            if (input == null)
                return false;
