...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class SubscriptionMetrics :  IEquatable<SubscriptionMetrics>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SubscriptionMetrics" /> class.
        /// </summary>
        ...
        public SubscriptionMetrics(string name = default(string), decimal? messageCount = default(decimal?))
        {
            // to ensure "name" is required (not null)
            if (name == null)
            {
                throw new InvalidDataException("name is a required property for SubscriptionMetrics and cannot be null");
            }
            else
            {
                this.Name = name;
            ...
            {
                throw new InvalidDataException("messageCount is a required property for SubscriptionMetrics and cannot be null");
            }
            else
            {
        ...
        {
            return this.Equals(input as SubscriptionMetrics);
        }

        /// <summary>
        /// Returns true if SubscriptionMetrics instances are equal
        /// </summary>
        /// <param name="input">Instance of SubscriptionMetrics to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SubscriptionMetrics input)
        {
            if (input == null)
                return false;
