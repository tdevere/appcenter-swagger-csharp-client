...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class LogFlowGenericLogContainerLogs :  IEquatable<LogFlowGenericLogContainerLogs>, IValidatableObject
    {
        /// <summary>
        /// Log type. 
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="LogFlowGenericLogContainerLogs" /> class.
        /// </summary>
        ...
        public LogFlowGenericLogContainerLogs(TypeEnum type = default(TypeEnum), DateTime? timestamp = default(DateTime?), Guid? installId = default(Guid?), Guid? sessionId = default(Guid?), string eventId = default(string), string eventName = default(string), string messageId = default(string), Dictionary<string, string> properties = default(Dictionary<string, string>), LogContainerDevice device = default(LogContainerDevice), string authProvider = default(string), string accountId = default(string))
        {
            // to ensure "type" is required (not null)
            if (type == null)
            {
                throw new InvalidDataException("type is a required property for LogFlowGenericLogContainerLogs and cannot be null");
            }
            else
            {
                this.Type = type;
            ...
            if (timestamp == null)
            {
                throw new InvalidDataException("timestamp is a required property for LogFlowGenericLogContainerLogs and cannot be null");
            }
            else
            {
            ...
            if (installId == null)
            {
                throw new InvalidDataException("installId is a required property for LogFlowGenericLogContainerLogs and cannot be null");
            }
            else
            {
            ...
            if (device == null)
            {
                throw new InvalidDataException("device is a required property for LogFlowGenericLogContainerLogs and cannot be null");
            }
            else
            {
                this.Device = device;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class LogFlowGenericLogContainerLogs {\n");
        ...
        {
            return this.Equals(input as LogFlowGenericLogContainerLogs);
        }

        /// <summary>
        /// Returns true if LogFlowGenericLogContainerLogs instances are equal
        /// </summary>
        /// <param name="input">Instance of LogFlowGenericLogContainerLogs to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(LogFlowGenericLogContainerLogs input)
        {
            if (input == null)
                return false;
