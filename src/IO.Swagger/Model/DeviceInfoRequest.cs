...
namespace IO.Swagger.Model
{
        ...
        public partial class DeviceInfoRequest :  IEquatable<DeviceInfoRequest>, IValidatableObject
    {
        ...
        public DeviceInfoRequest(string udid = default(string), string model = default(string), string osBuild = default(string), string osVersion = default(string), string serial = default(string), string imei = default(string), string ownerId = default(string))
        {
            // to ensure "udid" is required (not null)
            if (udid == null)
            {
                throw new InvalidDataException("udid is a required property for DeviceInfoRequest and cannot be null");
            }
            else
            {
                this.Udid = udid;
            ...
            if (model == null)
            {
                throw new InvalidDataException("model is a required property for DeviceInfoRequest and cannot be null");
            }
            else
            {
                this.Model = model;
