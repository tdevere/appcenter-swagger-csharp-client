...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class V01appsownerNameappNamereleasesreleaseIdBuild :  IEquatable<V01appsownerNameappNamereleasesreleaseIdBuild>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="V01appsownerNameappNamereleasesreleaseIdBuild" /> class.
        /// </summary>
        ...
        public V01appsownerNameappNamereleasesreleaseIdBuild(string branchName = default(string), string commitHash = default(string), string commitMessage = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class V01appsownerNameappNamereleasesreleaseIdBuild {\n");
        ...
        {
            return this.Equals(input as V01appsownerNameappNamereleasesreleaseIdBuild);
        }

        /// <summary>
        /// Returns true if V01appsownerNameappNamereleasesreleaseIdBuild instances are equal
        /// </summary>
        /// <param name="input">Instance of V01appsownerNameappNamereleasesreleaseIdBuild to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(V01appsownerNameappNamereleasesreleaseIdBuild input)
        {
            if (input == null)
                return false;
