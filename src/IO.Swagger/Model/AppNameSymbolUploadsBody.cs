...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class AppNameSymbolUploadsBody :  IEquatable<AppNameSymbolUploadsBody>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="AppNameSymbolUploadsBody" /> class.
        /// </summary>
        ...
        public AppNameSymbolUploadsBody(SymbolTypeEnum symbolType = default(SymbolTypeEnum), string clientCallback = default(string), string fileName = default(string), string build = default(string), string version = default(string))
        {
            // to ensure "symbolType" is required (not null)
            if (symbolType == null)
            {
                throw new InvalidDataException("symbolType is a required property for AppNameSymbolUploadsBody and cannot be null");
            }
            else
            {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class AppNameSymbolUploadsBody {\n");
        ...
        {
            return this.Equals(input as AppNameSymbolUploadsBody);
        }

        /// <summary>
        /// Returns true if AppNameSymbolUploadsBody instances are equal
        /// </summary>
        /// <param name="input">Instance of AppNameSymbolUploadsBody to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AppNameSymbolUploadsBody input)
        {
            if (input == null)
                return false;
