...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class OSesOses :  IEquatable<OSesOses>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="OSesOses" /> class.
        /// </summary>
        ...
        public OSesOses(string osName = default(string), long? count = default(long?), long? previousCount = default(long?))
        {
            this.OsName = osName;
            this.Count = count;
        ...
        {
            return this.Equals(input as OSesOses);
        }

        /// <summary>
        /// Returns true if OSesOses instances are equal
        /// </summary>
        /// <param name="input">Instance of OSesOses to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(OSesOses input)
        {
            if (input == null)
                return false;
