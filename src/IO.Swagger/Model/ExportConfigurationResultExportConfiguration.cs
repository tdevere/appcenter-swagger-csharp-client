...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class ExportConfigurationResultExportConfiguration :  IEquatable<ExportConfigurationResultExportConfiguration>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="ExportConfigurationResultExportConfiguration" /> class.
        /// </summary>
        ...
        public ExportConfigurationResultExportConfiguration(TypeEnum type = default(TypeEnum), List<ExportEntitiesEnum> exportEntities = default(List<ExportEntitiesEnum>), string resourceName = default(string), string resourceGroup = default(string), bool? backfill = default(bool?))
        {
            // to ensure "type" is required (not null)
            if (type == null)
            {
                throw new InvalidDataException("type is a required property for ExportConfigurationResultExportConfiguration and cannot be null");
            }
            else
            {
                this.Type = type;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ExportConfigurationResultExportConfiguration {\n");
        ...
        {
            return this.Equals(input as ExportConfigurationResultExportConfiguration);
        }

        /// <summary>
        /// Returns true if ExportConfigurationResultExportConfiguration instances are equal
        /// </summary>
        /// <param name="input">Instance of ExportConfigurationResultExportConfiguration to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ExportConfigurationResultExportConfiguration input)
        {
            if (input == null)
                return false;
