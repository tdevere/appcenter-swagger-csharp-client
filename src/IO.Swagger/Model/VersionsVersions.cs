...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class VersionsVersions :  IEquatable<VersionsVersions>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="VersionsVersions" /> class.
        /// </summary>
        /// <param name="version">Version..</param>
        /// <param name="count">Version count..</param>
        /// <param name="previousCount">The count of previous time range of the version..</param>
        public VersionsVersions(string version = default(string), long? count = default(long?), long? previousCount = default(long?))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class VersionsVersions {\n");
        ...
        {
            return this.Equals(input as VersionsVersions);
        }

        /// <summary>
        /// Returns true if VersionsVersions instances are equal
        /// </summary>
        /// <param name="input">Instance of VersionsVersions to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(VersionsVersions input)
        {
            if (input == null)
                return false;
