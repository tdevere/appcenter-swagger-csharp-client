...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class Toolsets :  IEquatable<Toolsets>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="Toolsets" /> class.
        /// </summary>
        ...
        public Toolsets(List<InlineResponse20017> xamarin = default(List<InlineResponse20017>), List<InlineResponse20016> xcode = default(List<InlineResponse20016>), List<ToolsetsNode> node = default(List<ToolsetsNode>))
        {
        ...
        {
            return this.Equals(input as Toolsets);
        }

        /// <summary>
        /// Returns true if Toolsets instances are equal
        /// </summary>
        /// <param name="input">Instance of Toolsets to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(Toolsets input)
        {
            if (input == null)
                return false;
