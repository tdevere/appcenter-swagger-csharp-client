...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class CrashGroup :  IEquatable<CrashGroup>, IValidatableObject
    {
        /// <summary>
        /// Defines Status
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="CrashGroup" /> class.
        /// </summary>
        ...
        public CrashGroup(string crashGroupId = default(string), string newCrashGroupId = default(string), string displayId = default(string), string appVersion = default(string), string build = default(string), StatusEnum status = default(StatusEnum), int? count = default(int?), int? impactedUsers = default(int?), DateTime? firstOccurrence = default(DateTime?), DateTime? lastOccurrence = default(DateTime?), string exception = default(string), string crashReason = default(string), CrashGroupsContainerReasonFrame reasonFrame = default(CrashGroupsContainerReasonFrame), bool? fatal = default(bool?), string annotation = default(string))
        {
            // to ensure "crashGroupId" is required (not null)
            if (crashGroupId == null)
            {
                throw new InvalidDataException("crashGroupId is a required property for CrashGroup and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("newCrashGroupId is a required property for CrashGroup and cannot be null");
            }
            else
            {
            ...
            if (displayId == null)
            {
                throw new InvalidDataException("displayId is a required property for CrashGroup and cannot be null");
            }
            else
            {
            ...
            if (appVersion == null)
            {
                throw new InvalidDataException("appVersion is a required property for CrashGroup and cannot be null");
            }
            else
            {
            ...
            if (build == null)
            {
                throw new InvalidDataException("build is a required property for CrashGroup and cannot be null");
            }
            else
            {
                this.Build = build;
            ...
            if (status == null)
            {
                throw new InvalidDataException("status is a required property for CrashGroup and cannot be null");
            }
            else
            {
                this.Status = status;
            ...
            if (count == null)
            {
                throw new InvalidDataException("count is a required property for CrashGroup and cannot be null");
            }
            else
            {
                this.Count = count;
            ...
            {
                throw new InvalidDataException("firstOccurrence is a required property for CrashGroup and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("lastOccurrence is a required property for CrashGroup and cannot be null");
            }
            else
            {
            ...
            if (crashReason == null)
            {
                throw new InvalidDataException("crashReason is a required property for CrashGroup and cannot be null");
            }
            else
            {
            ...
            if (fatal == null)
            {
                throw new InvalidDataException("fatal is a required property for CrashGroup and cannot be null");
            }
            else
            {
                this.Fatal = fatal;
            ...
            if (annotation == null)
            {
                throw new InvalidDataException("annotation is a required property for CrashGroup and cannot be null");
            }
            else
            {
        ...
        {
            return this.Equals(input as CrashGroup);
        }

        /// <summary>
        /// Returns true if CrashGroup instances are equal
        /// </summary>
        /// <param name="input">Instance of CrashGroup to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CrashGroup input)
        {
            if (input == null)
                return false;
