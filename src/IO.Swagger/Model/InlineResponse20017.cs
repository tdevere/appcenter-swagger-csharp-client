...
namespace IO.Swagger.Model
{
        ...
        public partial class InlineResponse20017 :  IEquatable<InlineResponse20017>, IValidatableObject
    {
        ...
        public InlineResponse20017(string monoVersion = default(string), string sdkBundle = default(string), bool? current = default(bool?), bool? stable = default(bool?), List<string> xcodeVersions = default(List<string>))
        {
