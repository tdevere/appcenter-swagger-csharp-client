...
namespace IO.Swagger.Model
{
        ...
        public partial class Branch :  IEquatable<Branch>, IValidatableObject
    {
        ...
        public Branch(string name = default(string), BranchPropertiesBranchCommit commit = default(BranchPropertiesBranchCommit))
        {
            // to ensure "name" is required (not null)
            if (name == null)
            {
                throw new InvalidDataException("name is a required property for Branch and cannot be null");
            }
            else
            {
                this.Name = name;
            ...
            if (commit == null)
            {
                throw new InvalidDataException("commit is a required property for Branch and cannot be null");
            }
            else
            {
                this.Commit = commit;
