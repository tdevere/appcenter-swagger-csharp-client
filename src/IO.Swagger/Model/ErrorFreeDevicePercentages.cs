...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class ErrorFreeDevicePercentages :  IEquatable<ErrorFreeDevicePercentages>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ErrorFreeDevicePercentages" /> class.
        /// </summary>
        /// <param name="averagePercentage">Average percentage.</param>
        /// <param name="dailyPercentages">The error-free percentage per day..</param>
        public ErrorFreeDevicePercentages(double? averagePercentage = default(double?), List<ErrorFreeDevicePercentagesDailyPercentages> dailyPercentages = default(List<ErrorFreeDevicePercentagesDailyPercentages>))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ErrorFreeDevicePercentages {\n");
        ...
        {
            return this.Equals(input as ErrorFreeDevicePercentages);
        }

        /// <summary>
        /// Returns true if ErrorFreeDevicePercentages instances are equal
        /// </summary>
        /// <param name="input">Instance of ErrorFreeDevicePercentages to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ErrorFreeDevicePercentages input)
        {
            if (input == null)
                return false;
