...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class DistributionGroupUserGetResponse :  IEquatable<DistributionGroupUserGetResponse>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="DistributionGroupUserGetResponse" /> class.
        /// </summary>
        ...
        public DistributionGroupUserGetResponse(Guid? id = default(Guid?), string avatarUrl = default(string), bool? canChangePassword = default(bool?), string displayName = default(string), string email = default(string), bool? invitePending = default(bool?), string name = default(string))
        {
            // to ensure "email" is required (not null)
            if (email == null)
            {
                throw new InvalidDataException("email is a required property for DistributionGroupUserGetResponse and cannot be null");
            }
            else
            {
                this.Email = email;
        ...
        {
            return this.Equals(input as DistributionGroupUserGetResponse);
        }

        /// <summary>
        /// Returns true if DistributionGroupUserGetResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of DistributionGroupUserGetResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(DistributionGroupUserGetResponse input)
        {
            if (input == null)
                return false;
