...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class TransferAppAdminRequest :  IEquatable<TransferAppAdminRequest>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TransferAppAdminRequest" /> class.
        /// </summary>
        /// <param name="newOwnerId">The internal unique id (UUID) of the user/org. (required).</param>
        ...
        public TransferAppAdminRequest(Guid? newOwnerId = default(Guid?), string issueId = default(string), string transferReason = default(string), Guid? responsibleAdminId = default(Guid?))
        {
            // to ensure "newOwnerId" is required (not null)
            if (newOwnerId == null)
            {
                throw new InvalidDataException("newOwnerId is a required property for TransferAppAdminRequest and cannot be null");
            }
            else
            {
            ...
            if (issueId == null)
            {
                throw new InvalidDataException("issueId is a required property for TransferAppAdminRequest and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("transferReason is a required property for TransferAppAdminRequest and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("responsibleAdminId is a required property for TransferAppAdminRequest and cannot be null");
            }
            else
            {
        ...
        /// </summary>
        /// <value>The internal unique id (UUID) of the user/org.</value>
        ...
        {
            return this.Equals(input as TransferAppAdminRequest);
        }

        /// <summary>
        /// Returns true if TransferAppAdminRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of TransferAppAdminRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TransferAppAdminRequest input)
        {
            if (input == null)
                return false;
