...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class ReleaseTesterDestinationRequest :  IEquatable<ReleaseTesterDestinationRequest>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ReleaseTesterDestinationRequest" /> class.
        /// </summary>
        ...
        public ReleaseTesterDestinationRequest(bool? mandatoryUpdate = default(bool?), string email = default(string), bool? notifyTesters = true)
        {
            // to ensure "email" is required (not null)
            if (email == null)
            {
                throw new InvalidDataException("email is a required property for ReleaseTesterDestinationRequest and cannot be null");
            }
            else
            {
                this.Email = email;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ReleaseTesterDestinationRequest {\n");
        ...
        {
            return this.Equals(input as ReleaseTesterDestinationRequest);
        }

        /// <summary>
        /// Returns true if ReleaseTesterDestinationRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of ReleaseTesterDestinationRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ReleaseTesterDestinationRequest input)
        {
            if (input == null)
                return false;
