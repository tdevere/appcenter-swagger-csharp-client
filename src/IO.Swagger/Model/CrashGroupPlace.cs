...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class CrashGroupPlace :  IEquatable<CrashGroupPlace>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CrashGroupPlace" /> class.
        /// </summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CrashGroupPlace {\n");
        ...
        {
            return this.Equals(input as CrashGroupPlace);
        }

        /// <summary>
        /// Returns true if CrashGroupPlace instances are equal
        /// </summary>
        /// <param name="input">Instance of CrashGroupPlace to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CrashGroupPlace input)
        {
            if (input == null)
                return false;
