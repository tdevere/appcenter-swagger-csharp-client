...
{
    /// <summary>
    /// XcodeSchemeArchiveProject
    /// </summary>
    [DataContract]
        public partial class XcodeSchemeArchiveProject :  IEquatable<XcodeSchemeArchiveProject>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="XcodeSchemeArchiveProject" /> class.
        /// </summary>
        ...
        public XcodeSchemeArchiveProject(string archiveTargetId = default(string), string projectName = default(string), string projectPath = default(string))
        {
            // to ensure "archiveTargetId" is required (not null)
            if (archiveTargetId == null)
            {
                throw new InvalidDataException("archiveTargetId is a required property for XcodeSchemeArchiveProject and cannot be null");
            }
            else
            {
            ...
            if (projectName == null)
            {
                throw new InvalidDataException("projectName is a required property for XcodeSchemeArchiveProject and cannot be null");
            }
            else
            {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class XcodeSchemeArchiveProject {\n");
        ...
        {
            return this.Equals(input as XcodeSchemeArchiveProject);
        }

        /// <summary>
        /// Returns true if XcodeSchemeArchiveProject instances are equal
        /// </summary>
        /// <param name="input">Instance of XcodeSchemeArchiveProject to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(XcodeSchemeArchiveProject input)
        {
            if (input == null)
                return false;
