...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class GitHubAccountLite :  IEquatable<GitHubAccountLite>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="GitHubAccountLite" /> class.
        /// </summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class GitHubAccountLite {\n");
        ...
        {
            return this.Equals(input as GitHubAccountLite);
        }

        /// <summary>
        /// Returns true if GitHubAccountLite instances are equal
        /// </summary>
        /// <param name="input">Instance of GitHubAccountLite to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GitHubAccountLite input)
        {
            if (input == null)
                return false;
