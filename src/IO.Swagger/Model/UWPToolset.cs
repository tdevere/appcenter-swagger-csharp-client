...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class UWPToolset :  IEquatable<UWPToolset>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="UWPToolset" /> class.
        /// </summary>
        /// <param name="uwpSolutions">The UWP solutions detected (required).</param>
        public UWPToolset(List<UWPToolsetUwpSolutions> uwpSolutions = default(List<UWPToolsetUwpSolutions>))
        {
            // to ensure "uwpSolutions" is required (not null)
            if (uwpSolutions == null)
            {
                throw new InvalidDataException("uwpSolutions is a required property for UWPToolset and cannot be null");
            }
            else
            {
        ...
        {
            return this.Equals(input as UWPToolset);
        }

        /// <summary>
        /// Returns true if UWPToolset instances are equal
        /// </summary>
        /// <param name="input">Instance of UWPToolset to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(UWPToolset input)
        {
            if (input == null)
                return false;
