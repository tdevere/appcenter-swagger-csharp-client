...
{
    /// <summary>
    /// ToolsetProjectsXcode
    /// </summary>
    [DataContract]
        public partial class ToolsetProjectsXcode :  IEquatable<ToolsetProjectsXcode>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ToolsetProjectsXcode" /> class.
        /// </summary>
        /// <param name="xcodeSchemeContainers">The Xcode scheme containers (required).</param>
        public ToolsetProjectsXcode(List<XcodeToolsetXcodeSchemeContainers> xcodeSchemeContainers = default(List<XcodeToolsetXcodeSchemeContainers>))
        {
            // to ensure "xcodeSchemeContainers" is required (not null)
            if (xcodeSchemeContainers == null)
            {
                throw new InvalidDataException("xcodeSchemeContainers is a required property for ToolsetProjectsXcode and cannot be null");
            }
            else
            {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ToolsetProjectsXcode {\n");
        ...
        {
            return this.Equals(input as ToolsetProjectsXcode);
        }

        /// <summary>
        /// Returns true if ToolsetProjectsXcode instances are equal
        /// </summary>
        /// <param name="input">Instance of ToolsetProjectsXcode to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ToolsetProjectsXcode input)
        {
            if (input == null)
                return false;
