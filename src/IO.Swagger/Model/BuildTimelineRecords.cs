...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class BuildTimelineRecords :  IEquatable<BuildTimelineRecords>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="BuildTimelineRecords" /> class.
        /// </summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class BuildTimelineRecords {\n");
        ...
        {
            return this.Equals(input as BuildTimelineRecords);
        }

        /// <summary>
        /// Returns true if BuildTimelineRecords instances are equal
        /// </summary>
        /// <param name="input">Instance of BuildTimelineRecords to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(BuildTimelineRecords input)
        {
            if (input == null)
                return false;
