...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class UpdateExternalUrlRequest :  IEquatable<UpdateExternalUrlRequest>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="UpdateExternalUrlRequest" /> class.
        /// </summary>
        /// <param name="externalDownloadUrl">The external URL to the release&#x27;s binary. (required).</param>
        public UpdateExternalUrlRequest(string externalDownloadUrl = default(string))
        {
            // to ensure "externalDownloadUrl" is required (not null)
            if (externalDownloadUrl == null)
            {
                throw new InvalidDataException("externalDownloadUrl is a required property for UpdateExternalUrlRequest and cannot be null");
            }
            else
            {
        ...
        {
            return this.Equals(input as UpdateExternalUrlRequest);
        }

        /// <summary>
        /// Returns true if UpdateExternalUrlRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of UpdateExternalUrlRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(UpdateExternalUrlRequest input)
        {
            if (input == null)
                return false;
