...
namespace IO.Swagger.Model
{
        ...
        public partial class InlineResponseDefault2 :  IEquatable<InlineResponseDefault2>, IValidatableObject
    {
        ...
        public InlineResponseDefault2(ErrorResponseError error = default(ErrorResponseError))
        {
            // to ensure "error" is required (not null)
            if (error == null)
            {
                throw new InvalidDataException("error is a required property for InlineResponseDefault2 and cannot be null");
            }
            else
            {
                this.Error = error;
