...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class ServiceBillingPlans :  IEquatable<ServiceBillingPlans>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ServiceBillingPlans" /> class.
        /// </summary>
        ...
        public ServiceBillingPlans(bool? canSelectTrialPlan = default(bool?), string lastTrialPlanExpirationTime = default(string), AggregatedBillingInformationBillingPlansBuildServiceCurrentBillingPeriod currentBillingPeriod = default(AggregatedBillingInformationBillingPlansBuildServiceCurrentBillingPeriod))
        {
        ...
        {
            return this.Equals(input as ServiceBillingPlans);
        }

        /// <summary>
        /// Returns true if ServiceBillingPlans instances are equal
        /// </summary>
        /// <param name="input">Instance of ServiceBillingPlans to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ServiceBillingPlans input)
        {
            if (input == null)
                return false;
