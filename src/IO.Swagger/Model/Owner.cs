...
namespace IO.Swagger.Model
{
        ...
        public partial class Owner :  IEquatable<Owner>, IValidatableObject
    {
        ...
        public Owner(Guid? id = default(Guid?), string avatarUrl = default(string), string displayName = default(string), string email = default(string), string name = default(string), TypeEnum type = default(TypeEnum))
        {
            // to ensure "id" is required (not null)
            if (id == null)
            {
                throw new InvalidDataException("id is a required property for Owner and cannot be null");
            }
            else
            {
                this.Id = id;
            ...
            if (displayName == null)
            {
                throw new InvalidDataException("displayName is a required property for Owner and cannot be null");
            }
            else
            {
            ...
            if (name == null)
            {
                throw new InvalidDataException("name is a required property for Owner and cannot be null");
            }
            else
            {
                this.Name = name;
            ...
            if (type == null)
            {
                throw new InvalidDataException("type is a required property for Owner and cannot be null");
            }
            else
            {
                this.Type = type;
