...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class GenericLogContainerLogs :  IEquatable<GenericLogContainerLogs>, IValidatableObject
    {
        /// <summary>
        /// Log type. 
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="GenericLogContainerLogs" /> class.
        /// </summary>
        ...
        public GenericLogContainerLogs(TypeEnum type = default(TypeEnum), DateTime? timestamp = default(DateTime?), Guid? installId = default(Guid?), Guid? sessionId = default(Guid?), string eventId = default(string), string eventName = default(string), string messageId = default(string), Dictionary<string, string> properties = default(Dictionary<string, string>), LogContainerDevice device = default(LogContainerDevice), string authProvider = default(string), string accountId = default(string))
        {
            // to ensure "type" is required (not null)
            if (type == null)
            {
                throw new InvalidDataException("type is a required property for GenericLogContainerLogs and cannot be null");
            }
            else
            {
                this.Type = type;
            ...
            if (timestamp == null)
            {
                throw new InvalidDataException("timestamp is a required property for GenericLogContainerLogs and cannot be null");
            }
            else
            {
            ...
            if (installId == null)
            {
                throw new InvalidDataException("installId is a required property for GenericLogContainerLogs and cannot be null");
            }
            else
            {
            ...
            if (device == null)
            {
                throw new InvalidDataException("device is a required property for GenericLogContainerLogs and cannot be null");
            }
            else
            {
                this.Device = device;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class GenericLogContainerLogs {\n");
        ...
        {
            return this.Equals(input as GenericLogContainerLogs);
        }

        /// <summary>
        /// Returns true if GenericLogContainerLogs instances are equal
        /// </summary>
        /// <param name="input">Instance of GenericLogContainerLogs to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GenericLogContainerLogs input)
        {
            if (input == null)
                return false;
