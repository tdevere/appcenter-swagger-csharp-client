...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class ExportConfigurationListResultValues :  IEquatable<ExportConfigurationListResultValues>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="ExportConfigurationListResultValues" /> class.
        /// </summary>
        ...
        public ExportConfigurationListResultValues(string id = default(string), ExportTypeEnum exportType = default(ExportTypeEnum), string creationTime = default(string), string lastRunTime = default(string), List<ExportEntitiesEnum> exportEntities = default(List<ExportEntitiesEnum>), StateEnum state = default(StateEnum), string stateInfo = default(string), string resourceGroup = default(string), string resourceName = default(string), ExportConfigurationResultExportConfiguration exportConfiguration = default(ExportConfigurationResultExportConfiguration))
        {
            // to ensure "id" is required (not null)
            if (id == null)
            {
                throw new InvalidDataException("id is a required property for ExportConfigurationListResultValues and cannot be null");
            }
            else
            {
                this.Id = id;
            ...
            if (exportType == null)
            {
                throw new InvalidDataException("exportType is a required property for ExportConfigurationListResultValues and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("creationTime is a required property for ExportConfigurationListResultValues and cannot be null");
            }
            else
            {
            ...
            if (state == null)
            {
                throw new InvalidDataException("state is a required property for ExportConfigurationListResultValues and cannot be null");
            }
            else
            {
                this.State = state;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ExportConfigurationListResultValues {\n");
        ...
        {
            return this.Equals(input as ExportConfigurationListResultValues);
        }

        /// <summary>
        /// Returns true if ExportConfigurationListResultValues instances are equal
        /// </summary>
        /// <param name="input">Instance of ExportConfigurationListResultValues to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ExportConfigurationListResultValues input)
        {
            if (input == null)
                return false;
