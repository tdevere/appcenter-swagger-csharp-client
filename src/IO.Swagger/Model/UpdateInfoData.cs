...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class UpdateInfoData :  IEquatable<UpdateInfoData>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="UpdateInfoData" /> class.
        /// </summary>
        ...
        public UpdateInfoData(string downloadUrl = default(string), bool? isAvailable = default(bool?), decimal? packageSize = default(decimal?), bool? shouldRunBinaryVersion = default(bool?), bool? updateAppVersion = default(bool?), string packageHash = default(string), string label = default(string))
        {
        ...
        {
            return this.Equals(input as UpdateInfoData);
        }

        /// <summary>
        /// Returns true if UpdateInfoData instances are equal
        /// </summary>
        /// <param name="input">Instance of UpdateInfoData to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(UpdateInfoData input)
        {
            if (input == null)
                return false;
