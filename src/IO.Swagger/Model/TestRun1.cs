...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class TestRun1 :  IEquatable<TestRun1>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TestRun1" /> class.
        /// </summary>
        ...
        public TestRun1(Guid? id = default(Guid?), string date = default(string), string appVersion = default(string), string testSeries = default(string), string platform = default(string), string runStatus = default(string), string resultStatus = default(string), string state = default(string), string status = default(string), string description = default(string), TestRunStatistics stats = default(TestRunStatistics), string testType = default(string))
        {
            this.Id = id;
            this.Date = date;
        ...
        {
            return this.Equals(input as TestRun1);
        }

        /// <summary>
        /// Returns true if TestRun1 instances are equal
        /// </summary>
        /// <param name="input">Instance of TestRun1 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TestRun1 input)
        {
            if (input == null)
                return false;
