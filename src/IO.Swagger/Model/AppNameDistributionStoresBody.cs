...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class AppNameDistributionStoresBody :  IEquatable<AppNameDistributionStoresBody>, IValidatableObject
    {
        /// <summary>
        /// store Type
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="AppNameDistributionStoresBody" /> class.
        /// </summary>
        ...
        public AppNameDistributionStoresBody(TypeEnum? type = default(TypeEnum?), string name = default(string), TrackEnum? track = default(TrackEnum?), V01appsownerNameappNamedistributionStoresIntuneDetails1 intuneDetails = default(V01appsownerNameappNamedistributionStoresIntuneDetails1), string serviceConnectionId = default(string))
        {
            this.Type = type;
            this.Name = name;
            this.Track = track;
        ...
        public V01appsownerNameappNamedistributionStoresIntuneDetails1 IntuneDetails { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class AppNameDistributionStoresBody {\n");
        ...
        {
            return this.Equals(input as AppNameDistributionStoresBody);
        }

        /// <summary>
        /// Returns true if AppNameDistributionStoresBody instances are equal
        /// </summary>
        /// <param name="input">Instance of AppNameDistributionStoresBody to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AppNameDistributionStoresBody input)
        {
            if (input == null)
                return false;
