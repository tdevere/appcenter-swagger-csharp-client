...
{
    /// <summary>
    /// ReportStatusDeployBody
    /// </summary>
    [DataContract]
        public partial class ReportStatusDeployBody :  IEquatable<ReportStatusDeployBody>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ReportStatusDeployBody" /> class.
        /// </summary>
        ...
        public ReportStatusDeployBody(string deploymentKey = default(string), string label = default(string), string appVersion = default(string), string previousDeploymentKey = default(string), string previousLabelOrAppVersion = default(string), string status = default(string), string clientUniqueId = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ReportStatusDeployBody {\n");
        ...
        {
            return this.Equals(input as ReportStatusDeployBody);
        }

        /// <summary>
        /// Returns true if ReportStatusDeployBody instances are equal
        /// </summary>
        /// <param name="input">Instance of ReportStatusDeployBody to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ReportStatusDeployBody input)
        {
            if (input == null)
                return false;
