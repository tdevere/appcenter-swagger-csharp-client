...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class AppRequest :  IEquatable<AppRequest>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="AppRequest" /> class.
        /// </summary>
        ...
        public AppRequest(string description = default(string), string releaseType = default(string), string displayName = default(string), string name = default(string), OsEnum os = default(OsEnum), PlatformEnum platform = default(PlatformEnum))
        {
            // to ensure "displayName" is required (not null)
            if (displayName == null)
            {
                throw new InvalidDataException("displayName is a required property for AppRequest and cannot be null");
            }
            else
            {
            ...
            if (os == null)
            {
                throw new InvalidDataException("os is a required property for AppRequest and cannot be null");
            }
            else
            {
                this.Os = os;
            ...
            if (platform == null)
            {
                throw new InvalidDataException("platform is a required property for AppRequest and cannot be null");
            }
            else
            {
        ...
        {
            return this.Equals(input as AppRequest);
        }

        /// <summary>
        /// Returns true if AppRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of AppRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AppRequest input)
        {
            if (input == null)
                return false;
