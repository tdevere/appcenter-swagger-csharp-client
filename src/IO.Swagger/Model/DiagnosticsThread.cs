...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class DiagnosticsThread :  IEquatable<DiagnosticsThread>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="DiagnosticsThread" /> class.
        /// </summary>
        ...
        public DiagnosticsThread(string title = default(string), List<ExceptionFrames> frames = default(List<ExceptionFrames>), DiagnosticsException exception = default(DiagnosticsException), bool? relevant = default(bool?), PlatformEnum? platform = default(PlatformEnum?), bool? crashed = default(bool?))
        {
            // to ensure "title" is required (not null)
            if (title == null)
            {
                throw new InvalidDataException("title is a required property for DiagnosticsThread and cannot be null");
            }
            else
            {
                this.Title = title;
            ...
            if (frames == null)
            {
                throw new InvalidDataException("frames is a required property for DiagnosticsThread and cannot be null");
            }
            else
            {
                this.Frames = frames;
        ...
        {
            return this.Equals(input as DiagnosticsThread);
        }

        /// <summary>
        /// Returns true if DiagnosticsThread instances are equal
        /// </summary>
        /// <param name="input">Instance of DiagnosticsThread to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(DiagnosticsThread input)
        {
            if (input == null)
                return false;
