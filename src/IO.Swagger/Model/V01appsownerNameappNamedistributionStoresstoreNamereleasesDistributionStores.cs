...
{
    /// <summary>
    /// V01appsownerNameappNamedistributionStoresstoreNamereleasesDistributionStores
    /// </summary>
    [DataContract]
        public partial class V01appsownerNameappNamedistributionStoresstoreNamereleasesDistributionStores :  IEquatable<V01appsownerNameappNamedistributionStoresstoreNamereleasesDistributionStores>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="V01appsownerNameappNamedistributionStoresstoreNamereleasesDistributionStores" /> class.
        /// </summary>
        ...
        public V01appsownerNameappNamedistributionStoresstoreNamereleasesDistributionStores(string id = default(string), string name = default(string), TypeEnum? type = default(TypeEnum?), string publishingStatus = default(string), bool? isLatest = default(bool?))
        {
            this.Id = id;
            this.Name = name;
            this.Type = type;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class V01appsownerNameappNamedistributionStoresstoreNamereleasesDistributionStores {\n");
        ...
        {
            return this.Equals(input as V01appsownerNameappNamedistributionStoresstoreNamereleasesDistributionStores);
        }

        /// <summary>
        /// Returns true if V01appsownerNameappNamedistributionStoresstoreNamereleasesDistributionStores instances are equal
        /// </summary>
        /// <param name="input">Instance of V01appsownerNameappNamedistributionStoresstoreNamereleasesDistributionStores to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(V01appsownerNameappNamedistributionStoresstoreNamereleasesDistributionStores input)
        {
            if (input == null)
                return false;
