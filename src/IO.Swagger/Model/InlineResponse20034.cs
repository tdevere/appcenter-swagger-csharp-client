...
namespace IO.Swagger.Model
{
        ...
        public partial class InlineResponse20034 :  IEquatable<InlineResponse20034>, IValidatableObject
    {
        ...
        public InlineResponse20034(int? id = default(int?), string version = default(string), OriginEnum? origin = default(OriginEnum?), string shortVersion = default(string), bool? enabled = default(bool?), string uploadedAt = default(string), DestinationTypeEnum? destinationType = default(DestinationTypeEnum?), List<AllOfinlineResponse20034DistributionGroupsItems> distributionGroups = default(List<AllOfinlineResponse20034DistributionGroupsItems>), List<AllOfinlineResponse20034DistributionStoresItems> distributionStores = default(List<AllOfinlineResponse20034DistributionStoresItems>), List<AllOfinlineResponse20034DestinationsItems> destinations = default(List<AllOfinlineResponse20034DestinationsItems>), V01appsownerNameappNamereleasesfilterByTesterBuild build = default(V01appsownerNameappNamereleasesfilterByTesterBuild), bool? isExternalBuild = default(bool?), string fileExtension = default(string))
        {
            // to ensure "id" is required (not null)
            if (id == null)
            {
                throw new InvalidDataException("id is a required property for InlineResponse20034 and cannot be null");
            }
            else
            {
                this.Id = id;
            ...
            if (version == null)
            {
                throw new InvalidDataException("version is a required property for InlineResponse20034 and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("shortVersion is a required property for InlineResponse20034 and cannot be null");
            }
            else
            {
            ...
            if (enabled == null)
            {
                throw new InvalidDataException("enabled is a required property for InlineResponse20034 and cannot be null");
            }
            else
            {
            ...
            if (uploadedAt == null)
            {
                throw new InvalidDataException("uploadedAt is a required property for InlineResponse20034 and cannot be null");
            }
            else
            {
        ...
        public List<AllOfinlineResponse20034DistributionGroupsItems> DistributionGroups { get; set; }
        ...
        public List<AllOfinlineResponse20034DistributionStoresItems> DistributionStores { get; set; }
        ...
        public List<AllOfinlineResponse20034DestinationsItems> Destinations { get; set; }
