...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class ReleaseIdGroupsBody :  IEquatable<ReleaseIdGroupsBody>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ReleaseIdGroupsBody" /> class.
        /// </summary>
        ...
        public ReleaseIdGroupsBody(bool? mandatoryUpdate = default(bool?), bool? notifyTesters = true)
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ReleaseIdGroupsBody {\n");
        ...
        {
            return this.Equals(input as ReleaseIdGroupsBody);
        }

        /// <summary>
        /// Returns true if ReleaseIdGroupsBody instances are equal
        /// </summary>
        /// <param name="input">Instance of ReleaseIdGroupsBody to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ReleaseIdGroupsBody input)
        {
            if (input == null)
                return false;
