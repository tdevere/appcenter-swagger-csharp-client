...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class BranchConfigurationRevision :  IEquatable<BranchConfigurationRevision>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="BranchConfigurationRevision" /> class.
        /// </summary>
        ...
        public BranchConfigurationRevision(string id = default(string), decimal? revision = default(decimal?), string changedDate = default(string), string name = default(string), string changeType = default(string), string definitionUrl = default(string), BranchConfigurationRevisionChangedBy changedBy = default(BranchConfigurationRevisionChangedBy))
        {
            this.Id = id;
        ...
        public BranchConfigurationRevisionChangedBy ChangedBy { get; set; }
        ...
        {
            return this.Equals(input as BranchConfigurationRevision);
        }

        /// <summary>
        /// Returns true if BranchConfigurationRevision instances are equal
        /// </summary>
        /// <param name="input">Instance of BranchConfigurationRevision to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(BranchConfigurationRevision input)
        {
            if (input == null)
                return false;
