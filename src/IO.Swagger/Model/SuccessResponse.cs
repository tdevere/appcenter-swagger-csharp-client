...
namespace IO.Swagger.Model
{
        ...
        public partial class SuccessResponse :  IEquatable<SuccessResponse>, IValidatableObject
    {
        ...
        public SuccessResponse(string message = default(string))
        {
            // to ensure "message" is required (not null)
            if (message == null)
            {
                throw new InvalidDataException("message is a required property for SuccessResponse and cannot be null");
            }
            else
            {
