...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class SessionDurationsDistribution :  IEquatable<SessionDurationsDistribution>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SessionDurationsDistribution" /> class.
        /// </summary>
        ...
        public SessionDurationsDistribution(List<SessionDurationsDistributionDistribution> distribution = default(List<SessionDurationsDistributionDistribution>), string previousAverageDuration = default(string), string averageDuration = default(string))
        {
        ...
        {
            return this.Equals(input as SessionDurationsDistribution);
        }

        /// <summary>
        /// Returns true if SessionDurationsDistribution instances are equal
        /// </summary>
        /// <param name="input">Instance of SessionDurationsDistribution to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SessionDurationsDistribution input)
        {
            if (input == null)
                return false;
