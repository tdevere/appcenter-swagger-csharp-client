...
{
    /// <summary>
    /// AnalyticsModelsModels
    /// </summary>
    [DataContract]
        public partial class AnalyticsModelsModels :  IEquatable<AnalyticsModelsModels>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="AnalyticsModelsModels" /> class.
        /// </summary>
        ...
        public AnalyticsModelsModels(string modelName = default(string), long? count = default(long?), long? previousCount = default(long?))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class AnalyticsModelsModels {\n");
        ...
        {
            return this.Equals(input as AnalyticsModelsModels);
        }

        /// <summary>
        /// Returns true if AnalyticsModelsModels instances are equal
        /// </summary>
        /// <param name="input">Instance of AnalyticsModelsModels to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AnalyticsModelsModels input)
        {
            if (input == null)
                return false;
