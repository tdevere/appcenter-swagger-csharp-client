...
namespace IO.Swagger.Model
{
        ...
        public partial class InlineResponse20029 :  IEquatable<InlineResponse20029>, IValidatableObject
    {
        ...
        public InlineResponse20029(string uri = default(string))
        {
            // to ensure "uri" is required (not null)
            if (uri == null)
            {
                throw new InvalidDataException("uri is a required property for InlineResponse20029 and cannot be null");
            }
            else
            {
                this.Uri = uri;
