...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class V01appsownerNameappNamereleasesreleaseIdDestinations :  IEquatable<V01appsownerNameappNamereleasesreleaseIdDestinations>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="V01appsownerNameappNamereleasesreleaseIdDestinations" /> class.
        /// </summary>
        ...
        public V01appsownerNameappNamereleasesreleaseIdDestinations(string name = default(string), string id = default(string))
        {
            this.Name = name;
            this.Id = id;
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class V01appsownerNameappNamereleasesreleaseIdDestinations {\n");
        ...
        {
            return this.Equals(input as V01appsownerNameappNamereleasesreleaseIdDestinations);
        }

        /// <summary>
        /// Returns true if V01appsownerNameappNamereleasesreleaseIdDestinations instances are equal
        /// </summary>
        /// <param name="input">Instance of V01appsownerNameappNamereleasesreleaseIdDestinations to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(V01appsownerNameappNamereleasesreleaseIdDestinations input)
        {
            if (input == null)
                return false;
