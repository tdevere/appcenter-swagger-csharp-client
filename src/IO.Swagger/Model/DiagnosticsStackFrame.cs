...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class DiagnosticsStackFrame :  IEquatable<DiagnosticsStackFrame>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="DiagnosticsStackFrame" /> class.
        /// </summary>
        ...
        /// <param name="appCode">this line isn&#x27;t from any framework (required).</param>
        /// <param name="frameworkName">Name of the framework.</param>
        /// <param name="codeRaw">Raw frame string (required).</param>
        /// <param name="codeFormatted">Formatted frame string (required).</param>
        ...
        public DiagnosticsStackFrame(string address = default(string), string className = default(string), string method = default(string), bool? classMethod = default(bool?), string file = default(string), int? line = default(int?), bool? appCode = default(bool?), string frameworkName = default(string), string codeRaw = default(string), string codeFormatted = default(string), LanguageEnum? language = default(LanguageEnum?), bool? relevant = default(bool?), string methodParams = default(string))
        {
            // to ensure "appCode" is required (not null)
            if (appCode == null)
            {
                throw new InvalidDataException("appCode is a required property for DiagnosticsStackFrame and cannot be null");
            }
            else
            {
                this.AppCode = appCode;
            }
            // to ensure "codeRaw" is required (not null)
            if (codeRaw == null)
            {
                throw new InvalidDataException("codeRaw is a required property for DiagnosticsStackFrame and cannot be null");
            }
            else
            {
                this.CodeRaw = codeRaw;
            }
            // to ensure "codeFormatted" is required (not null)
            if (codeFormatted == null)
            {
                throw new InvalidDataException("codeFormatted is a required property for DiagnosticsStackFrame and cannot be null");
            }
            else
            {
        ...
        /// </summary>
        /// <value>address of the frame</value>
        ...
        /// </summary>
        /// <value>frame should be shown always</value>
        ...
        {
            return this.Equals(input as DiagnosticsStackFrame);
        }

        /// <summary>
        /// Returns true if DiagnosticsStackFrame instances are equal
        /// </summary>
        /// <param name="input">Instance of DiagnosticsStackFrame to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(DiagnosticsStackFrame input)
        {
            if (input == null)
                return false;
