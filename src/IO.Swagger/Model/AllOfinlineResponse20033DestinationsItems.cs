...
{
    /// <summary>
    /// AllOfinlineResponse20033DestinationsItems
    /// </summary>
    [DataContract]
        public partial class AllOfinlineResponse20033DestinationsItems :  IEquatable<AllOfinlineResponse20033DestinationsItems>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="AllOfinlineResponse20033DestinationsItems" /> class.
        /// </summary>
        ...
        public AllOfinlineResponse20033DestinationsItems(bool? isLatest = default(bool?), string name = default(string), string id = default(string), DestinationTypeEnum? destinationType = default(DestinationTypeEnum?), string displayName = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class AllOfinlineResponse20033DestinationsItems {\n");
        ...
        {
            return this.Equals(input as AllOfinlineResponse20033DestinationsItems);
        }

        /// <summary>
        /// Returns true if AllOfinlineResponse20033DestinationsItems instances are equal
        /// </summary>
        /// <param name="input">Instance of AllOfinlineResponse20033DestinationsItems to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AllOfinlineResponse20033DestinationsItems input)
        {
            if (input == null)
                return false;
