...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class DeviceSetConfiguration :  IEquatable<DeviceSetConfiguration>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="DeviceSetConfiguration" /> class.
        /// </summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class DeviceSetConfiguration {\n");
        ...
        {
            return this.Equals(input as DeviceSetConfiguration);
        }

        /// <summary>
        /// Returns true if DeviceSetConfiguration instances are equal
        /// </summary>
        /// <param name="input">Instance of DeviceSetConfiguration to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(DeviceSetConfiguration input)
        {
            if (input == null)
                return false;
