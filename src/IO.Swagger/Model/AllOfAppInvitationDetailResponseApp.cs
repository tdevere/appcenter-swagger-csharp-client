...
{
    /// <summary>
    /// AllOfAppInvitationDetailResponseApp
    /// </summary>
    [DataContract]
        public partial class AllOfAppInvitationDetailResponseApp :  IEquatable<AllOfAppInvitationDetailResponseApp>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="AllOfAppInvitationDetailResponseApp" /> class.
        /// </summary>
        ...
        public AllOfAppInvitationDetailResponseApp(string appSecret = default(string), Object azureSubscription = default(Object), PlatformEnum? platform = default(PlatformEnum?), OriginEnum? origin = default(OriginEnum?), string createdAt = default(string), string updatedAt = default(string), List<MemberPermissionsEnum> memberPermissions = default(List<MemberPermissionsEnum>))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class AllOfAppInvitationDetailResponseApp {\n");
        ...
        {
            return this.Equals(input as AllOfAppInvitationDetailResponseApp);
        }

        /// <summary>
        /// Returns true if AllOfAppInvitationDetailResponseApp instances are equal
        /// </summary>
        /// <param name="input">Instance of AllOfAppInvitationDetailResponseApp to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AllOfAppInvitationDetailResponseApp input)
        {
            if (input == null)
                return false;
