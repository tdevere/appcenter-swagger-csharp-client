...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class AlertWebhookListResultValues :  IEquatable<AlertWebhookListResultValues>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="AlertWebhookListResultValues" /> class.
        /// </summary>
        ...
        public AlertWebhookListResultValues(string id = default(string), string name = default(string), string url = default(string), bool? enabled = default(bool?), List<EventTypesEnum> eventTypes = default(List<EventTypesEnum>))
        {
            // to ensure "name" is required (not null)
            if (name == null)
            {
                throw new InvalidDataException("name is a required property for AlertWebhookListResultValues and cannot be null");
            }
            else
            {
                this.Name = name;
            ...
            if (url == null)
            {
                throw new InvalidDataException("url is a required property for AlertWebhookListResultValues and cannot be null");
            }
            else
            {
                this.Url = url;
            ...
            if (eventTypes == null)
            {
                throw new InvalidDataException("eventTypes is a required property for AlertWebhookListResultValues and cannot be null");
            }
            else
            {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class AlertWebhookListResultValues {\n");
        ...
        {
            return this.Equals(input as AlertWebhookListResultValues);
        }

        /// <summary>
        /// Returns true if AlertWebhookListResultValues instances are equal
        /// </summary>
        /// <param name="input">Instance of AlertWebhookListResultValues to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AlertWebhookListResultValues input)
        {
            if (input == null)
                return false;
