...
{
    /// <summary>
    /// AllOfappNameDeploymentsBodyLatestRelease
    /// </summary>
    [DataContract]
        public partial class AllOfappNameDeploymentsBodyLatestRelease :  IEquatable<AllOfappNameDeploymentsBodyLatestRelease>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="AllOfappNameDeploymentsBodyLatestRelease" /> class.
        /// </summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class AllOfappNameDeploymentsBodyLatestRelease {\n");
        ...
        {
            return this.Equals(input as AllOfappNameDeploymentsBodyLatestRelease);
        }

        /// <summary>
        /// Returns true if AllOfappNameDeploymentsBodyLatestRelease instances are equal
        /// </summary>
        /// <param name="input">Instance of AllOfappNameDeploymentsBodyLatestRelease to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AllOfappNameDeploymentsBodyLatestRelease input)
        {
            if (input == null)
                return false;
