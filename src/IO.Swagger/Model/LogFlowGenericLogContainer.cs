...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class LogFlowGenericLogContainer :  IEquatable<LogFlowGenericLogContainer>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="LogFlowGenericLogContainer" /> class.
        /// </summary>
        ...
        public LogFlowGenericLogContainer(bool? exceededMaxLimit = default(bool?), DateTime? lastReceivedLogTimestamp = default(DateTime?), List<LogFlowGenericLogContainerLogs> logs = default(List<LogFlowGenericLogContainerLogs>))
        {
            // to ensure "logs" is required (not null)
            if (logs == null)
            {
                throw new InvalidDataException("logs is a required property for LogFlowGenericLogContainer and cannot be null");
            }
            else
            {
                this.Logs = logs;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class LogFlowGenericLogContainer {\n");
        ...
        {
            return this.Equals(input as LogFlowGenericLogContainer);
        }

        /// <summary>
        /// Returns true if LogFlowGenericLogContainer instances are equal
        /// </summary>
        /// <param name="input">Instance of LogFlowGenericLogContainer to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(LogFlowGenericLogContainer input)
        {
            if (input == null)
                return false;
