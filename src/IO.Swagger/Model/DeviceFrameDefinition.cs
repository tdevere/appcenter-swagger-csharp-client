...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class DeviceFrameDefinition :  IEquatable<DeviceFrameDefinition>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="DeviceFrameDefinition" /> class.
        /// </summary>
        /// <param name="width">width.</param>
        /// <param name="height">height.</param>
        /// <param name="frameUrl">frameUrl.</param>
        /// <param name="screen">screen.</param>
        public DeviceFrameDefinition(decimal? width = default(decimal?), decimal? height = default(decimal?), string frameUrl = default(string), List<decimal?> screen = default(List<decimal?>))
        {
            this.Width = width;
            this.Height = height;
        ...
        {
            return this.Equals(input as DeviceFrameDefinition);
        }

        /// <summary>
        /// Returns true if DeviceFrameDefinition instances are equal
        /// </summary>
        /// <param name="input">Instance of DeviceFrameDefinition to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(DeviceFrameDefinition input)
        {
            if (input == null)
                return false;
