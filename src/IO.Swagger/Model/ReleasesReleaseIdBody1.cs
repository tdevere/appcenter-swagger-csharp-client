...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class ReleasesReleaseIdBody1 :  IEquatable<ReleasesReleaseIdBody1>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ReleasesReleaseIdBody1" /> class.
        /// </summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ReleasesReleaseIdBody1 {\n");
        ...
        {
            return this.Equals(input as ReleasesReleaseIdBody1);
        }

        /// <summary>
        /// Returns true if ReleasesReleaseIdBody1 instances are equal
        /// </summary>
        /// <param name="input">Instance of ReleasesReleaseIdBody1 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ReleasesReleaseIdBody1 input)
        {
            if (input == null)
                return false;
