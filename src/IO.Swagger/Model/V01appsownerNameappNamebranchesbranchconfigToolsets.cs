...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class V01appsownerNameappNamebranchesbranchconfigToolsets :  IEquatable<V01appsownerNameappNamebranchesbranchconfigToolsets>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="V01appsownerNameappNamebranchesbranchconfigToolsets" /> class.
        /// </summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class V01appsownerNameappNamebranchesbranchconfigToolsets {\n");
        ...
        {
            return this.Equals(input as V01appsownerNameappNamebranchesbranchconfigToolsets);
        }

        /// <summary>
        /// Returns true if V01appsownerNameappNamebranchesbranchconfigToolsets instances are equal
        /// </summary>
        /// <param name="input">Instance of V01appsownerNameappNamebranchesbranchconfigToolsets to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(V01appsownerNameappNamebranchesbranchconfigToolsets input)
        {
            if (input == null)
                return false;
