...
{
    /// <summary>
    /// DeploymentNameReleasesBody
    /// </summary>
    [DataContract]
        public partial class DeploymentNameReleasesBody :  IEquatable<DeploymentNameReleasesBody>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="DeploymentNameReleasesBody" /> class.
        /// </summary>
        ...
        public DeploymentNameReleasesBody(V01appsownerNameappNamedeploymentsdeploymentNamereleasesReleaseUpload releaseUpload = default(V01appsownerNameappNamedeploymentsdeploymentNamereleasesReleaseUpload), string targetBinaryVersion = default(string), string deploymentName = default(string), string description = default(string), bool? disabled = default(bool?), bool? mandatory = default(bool?), bool? noDuplicateReleaseError = default(bool?), int? rollout = default(int?))
        {
            ...
            {
                throw new InvalidDataException("targetBinaryVersion is a required property for DeploymentNameReleasesBody and cannot be null");
            }
            else
            {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class DeploymentNameReleasesBody {\n");
        ...
        {
            return this.Equals(input as DeploymentNameReleasesBody);
        }

        /// <summary>
        /// Returns true if DeploymentNameReleasesBody instances are equal
        /// </summary>
        /// <param name="input">Instance of DeploymentNameReleasesBody to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(DeploymentNameReleasesBody input)
        {
            if (input == null)
                return false;
