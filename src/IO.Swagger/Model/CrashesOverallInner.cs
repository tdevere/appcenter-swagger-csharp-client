...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class CrashesOverallInner :  IEquatable<CrashesOverallInner>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CrashesOverallInner" /> class.
        /// </summary>
        /// <param name="crashGroupId">crashGroupId.</param>
        /// <param name="appVersion">appVersion.</param>
        /// <param name="overall">overall.</param>
        public CrashesOverallInner(string crashGroupId = default(string), string appVersion = default(string), Object overall = default(Object))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CrashesOverallInner {\n");
        ...
        {
            return this.Equals(input as CrashesOverallInner);
        }

        /// <summary>
        /// Returns true if CrashesOverallInner instances are equal
        /// </summary>
        /// <param name="input">Instance of CrashesOverallInner to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CrashesOverallInner input)
        {
            if (input == null)
                return false;
