...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class ItunesTeamsRequest :  IEquatable<ItunesTeamsRequest>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ItunesTeamsRequest" /> class.
        /// </summary>
        ...
        {
            return this.Equals(input as ItunesTeamsRequest);
        }

        /// <summary>
        /// Returns true if ItunesTeamsRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of ItunesTeamsRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ItunesTeamsRequest input)
        {
            if (input == null)
                return false;
