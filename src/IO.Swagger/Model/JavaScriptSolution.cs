...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class JavaScriptSolution :  IEquatable<JavaScriptSolution>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="JavaScriptSolution" /> class.
        /// </summary>
        ...
        public JavaScriptSolution(string packageJsonPath = default(string), string reactNativeVersion = default(string))
        {
            // to ensure "packageJsonPath" is required (not null)
            if (packageJsonPath == null)
            {
                throw new InvalidDataException("packageJsonPath is a required property for JavaScriptSolution and cannot be null");
            }
            else
            {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class JavaScriptSolution {\n");
        ...
        {
            return this.Equals(input as JavaScriptSolution);
        }

        /// <summary>
        /// Returns true if JavaScriptSolution instances are equal
        /// </summary>
        /// <param name="input">Instance of JavaScriptSolution to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(JavaScriptSolution input)
        {
            if (input == null)
                return false;
