...
namespace IO.Swagger.Model
{
        ...
        public partial class InlineResponse20071 :  IEquatable<InlineResponse20071>, IValidatableObject
    {
        ...
        public InlineResponse20071(bool? limitedResultSet = default(bool?), string continuationToken = default(string), List<CrashGroupsContainerCrashGroups> crashGroups = default(List<CrashGroupsContainerCrashGroups>))
        {
            // to ensure "limitedResultSet" is required (not null)
            if (limitedResultSet == null)
            {
                throw new InvalidDataException("limitedResultSet is a required property for InlineResponse20071 and cannot be null");
            }
            else
            {
            ...
            if (crashGroups == null)
            {
                throw new InvalidDataException("crashGroups is a required property for InlineResponse20071 and cannot be null");
            }
            else
            {
