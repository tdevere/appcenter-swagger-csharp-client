...
namespace IO.Swagger.Model
{
        ...
        public partial class Build :  IEquatable<Build>, IValidatableObject
    {
        ...
        public Build(int? id = default(int?), string buildNumber = default(string), string queueTime = default(string), string startTime = default(string), string finishTime = default(string), string lastChangedDate = default(string), string status = default(string), string result = default(string), string sourceBranch = default(string), string sourceVersion = default(string))
        {
            ...
            if (buildNumber == null)
            {
                throw new InvalidDataException("buildNumber is a required property for Build and cannot be null");
            }
            else
            {
            ...
            if (queueTime == null)
            {
                throw new InvalidDataException("queueTime is a required property for Build and cannot be null");
            }
            else
            {
            ...
            if (status == null)
            {
                throw new InvalidDataException("status is a required property for Build and cannot be null");
            }
            else
            {
                this.Status = status;
            ...
            {
                throw new InvalidDataException("sourceBranch is a required property for Build and cannot be null");
            }
            else
            {
