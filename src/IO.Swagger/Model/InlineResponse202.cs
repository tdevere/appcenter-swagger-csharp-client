...
namespace IO.Swagger.Model
{
        ...
        public partial class InlineResponse202 :  IEquatable<InlineResponse202>, IValidatableObject
    {
        ...
        public InlineResponse202(Guid? token = default(Guid?), DateTime? createdAt = default(DateTime?))
        {
            // to ensure "token" is required (not null)
            if (token == null)
            {
                throw new InvalidDataException("token is a required property for InlineResponse202 and cannot be null");
            }
            else
            {
                this.Token = token;
            ...
            if (createdAt == null)
            {
                throw new InvalidDataException("createdAt is a required property for InlineResponse202 and cannot be null");
            }
            else
            {
