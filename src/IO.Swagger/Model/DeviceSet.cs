...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class DeviceSet :  IEquatable<DeviceSet>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="DeviceSet" /> class.
        /// </summary>
        ...
        public DeviceSet(string id = default(string), decimal? manufacturerCount = default(decimal?), string name = default(string), string slug = default(string), DeviceSetOwner owner = default(DeviceSetOwner), decimal? osVersionCount = default(decimal?), List<V01appsownerNameappNameownerdeviceSetsDeviceConfigurations> deviceConfigurations = default(List<V01appsownerNameappNameownerdeviceSetsDeviceConfigurations>))
        {
            // to ensure "id" is required (not null)
            if (id == null)
            {
                throw new InvalidDataException("id is a required property for DeviceSet and cannot be null");
            }
            else
            {
                this.Id = id;
            ...
            if (name == null)
            {
                throw new InvalidDataException("name is a required property for DeviceSet and cannot be null");
            }
            else
            {
                this.Name = name;
            ...
            if (owner == null)
            {
                throw new InvalidDataException("owner is a required property for DeviceSet and cannot be null");
            }
            else
            {
                this.Owner = owner;
            ...
            {
                throw new InvalidDataException("deviceConfigurations is a required property for DeviceSet and cannot be null");
            }
            else
            {
        ...
        {
            return this.Equals(input as DeviceSet);
        }

        /// <summary>
        /// Returns true if DeviceSet instances are equal
        /// </summary>
        /// <param name="input">Instance of DeviceSet to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(DeviceSet input)
        {
            if (input == null)
                return false;
