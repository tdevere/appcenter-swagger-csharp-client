...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class AppleCertificateDetails :  IEquatable<AppleCertificateDetails>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="AppleCertificateDetails" /> class.
        /// </summary>
        ...
        public AppleCertificateDetails(string base64Certificate = default(string), string password = default(string))
        {
            // to ensure "base64Certificate" is required (not null)
            if (base64Certificate == null)
            {
                throw new InvalidDataException("base64Certificate is a required property for AppleCertificateDetails and cannot be null");
            }
            else
            {
            ...
            if (password == null)
            {
                throw new InvalidDataException("password is a required property for AppleCertificateDetails and cannot be null");
            }
            else
            {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class AppleCertificateDetails {\n");
        ...
        {
            return this.Equals(input as AppleCertificateDetails);
        }

        /// <summary>
        /// Returns true if AppleCertificateDetails instances are equal
        /// </summary>
        /// <param name="input">Instance of AppleCertificateDetails to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AppleCertificateDetails input)
        {
            if (input == null)
                return false;
