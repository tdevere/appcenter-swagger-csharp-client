...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class InlineResponse20093 :  IEquatable<InlineResponse20093>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse20093" /> class.
        /// </summary>
        /// <param name="crashCount">crashCount.</param>
        /// <param name="operatingSystems">operatingSystems.</param>
        public InlineResponse20093(long? crashCount = default(long?), List<CrashGroupOperatingSystemsOperatingSystems> operatingSystems = default(List<CrashGroupOperatingSystemsOperatingSystems>))
        {
        ...
        {
            return this.Equals(input as InlineResponse20093);
        }

        /// <summary>
        /// Returns true if InlineResponse20093 instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponse20093 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse20093 input)
        {
            if (input == null)
                return false;
