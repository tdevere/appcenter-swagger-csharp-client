...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class VSTSAccountsInner :  IEquatable<VSTSAccountsInner>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="VSTSAccountsInner" /> class.
        /// </summary>
        ...
        /// <param name="user">VSTS user profile.</param>
        /// <param name="projects">Account projects.</param>
        public VSTSAccountsInner(string accountId = default(string), string accountUri = default(string), string accountName = default(string), string accountType = default(string), string accountStatus = default(string), Object user = default(Object), List<Object> projects = default(List<Object>))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class VSTSAccountsInner {\n");
        ...
        {
            return this.Equals(input as VSTSAccountsInner);
        }

        /// <summary>
        /// Returns true if VSTSAccountsInner instances are equal
        /// </summary>
        /// <param name="input">Instance of VSTSAccountsInner to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(VSTSAccountsInner input)
        {
            if (input == null)
                return false;
