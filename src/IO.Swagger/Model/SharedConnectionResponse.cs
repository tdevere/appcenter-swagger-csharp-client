...
namespace IO.Swagger.Model
{
    ...
    [JsonConverter(typeof(JsonSubtypes), "serviceType")]
        public partial class SharedConnectionResponse :  IEquatable<SharedConnectionResponse>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="SharedConnectionResponse" /> class.
        /// </summary>
        ...
        public SharedConnectionResponse(string displayName = default(string), ServiceTypeEnum serviceType = default(ServiceTypeEnum), CredentialTypeEnum? credentialType = default(CredentialTypeEnum?))
        {
            // to ensure "displayName" is required (not null)
            if (displayName == null)
            {
                throw new InvalidDataException("displayName is a required property for SharedConnectionResponse and cannot be null");
            }
            else
            {
            ...
            if (serviceType == null)
            {
                throw new InvalidDataException("serviceType is a required property for SharedConnectionResponse and cannot be null");
            }
            else
            {
        ...
        {
            return this.Equals(input as SharedConnectionResponse);
        }

        /// <summary>
        /// Returns true if SharedConnectionResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of SharedConnectionResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SharedConnectionResponse input)
        {
            if (input == null)
                return false;
