...
namespace IO.Swagger.Model
{
        ...
        public partial class AudienceSummary :  IEquatable<AudienceSummary>, IValidatableObject
    {
        ...
        public AudienceSummary(string name = default(string), string description = default(string), long? estimatedCount = default(long?), string definition = default(string), StateEnum? state = default(StateEnum?))
        {
            this.Name = name;
