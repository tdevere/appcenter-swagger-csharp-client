...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class DataSubjectRightStatusResponse :  IEquatable<DataSubjectRightStatusResponse>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="DataSubjectRightStatusResponse" /> class.
        /// </summary>
        ...
        public DataSubjectRightStatusResponse(string sasUrl = default(string), bool? sasUrlExpired = default(bool?), StatusEnum status = default(StatusEnum), string message = default(string))
        {
            // to ensure "status" is required (not null)
            if (status == null)
            {
                throw new InvalidDataException("status is a required property for DataSubjectRightStatusResponse and cannot be null");
            }
            else
            {
                this.Status = status;
            ...
            if (message == null)
            {
                throw new InvalidDataException("message is a required property for DataSubjectRightStatusResponse and cannot be null");
            }
            else
            {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class DataSubjectRightStatusResponse {\n");
        ...
        {
            return this.Equals(input as DataSubjectRightStatusResponse);
        }

        /// <summary>
        /// Returns true if DataSubjectRightStatusResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of DataSubjectRightStatusResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(DataSubjectRightStatusResponse input)
        {
            if (input == null)
                return false;
