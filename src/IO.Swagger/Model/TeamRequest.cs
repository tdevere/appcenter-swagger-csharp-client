...
namespace IO.Swagger.Model
{
        ...
        public partial class TeamRequest :  IEquatable<TeamRequest>, IValidatableObject
    {
        ...
        public TeamRequest(string displayName = default(string), string name = default(string), string description = default(string))
        {
            // to ensure "displayName" is required (not null)
            if (displayName == null)
            {
                throw new InvalidDataException("displayName is a required property for TeamRequest and cannot be null");
            }
            else
            {
