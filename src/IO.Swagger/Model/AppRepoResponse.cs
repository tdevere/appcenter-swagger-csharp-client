...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class AppRepoResponse :  IEquatable<AppRepoResponse>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="AppRepoResponse" /> class.
        /// </summary>
        /// <param name="id">The unique id (UUID) of the repository integration (required).</param>
        /// <param name="appId">The unique id (UUID) of the app that this repository integration belongs to (required).</param>
        ...
        public AppRepoResponse(Guid? id = default(Guid?), Guid? appId = default(Guid?), string repoUrl = default(string), RepoProviderEnum? repoProvider = default(RepoProviderEnum?), Guid? userId = default(Guid?), string installationId = default(string), string repoId = default(string), string externalUserId = default(string), Guid? serviceConnectionId = default(Guid?))
        {
            // to ensure "id" is required (not null)
            if (id == null)
            {
                throw new InvalidDataException("id is a required property for AppRepoResponse and cannot be null");
            }
            else
            {
                this.Id = id;
            ...
            if (appId == null)
            {
                throw new InvalidDataException("appId is a required property for AppRepoResponse and cannot be null");
            }
            else
            {
                this.AppId = appId;
            ...
            if (repoUrl == null)
            {
                throw new InvalidDataException("repoUrl is a required property for AppRepoResponse and cannot be null");
            }
            else
            {
            ...
            if (userId == null)
            {
                throw new InvalidDataException("userId is a required property for AppRepoResponse and cannot be null");
            }
            else
            {
                this.UserId = userId;
        ...
        /// </summary>
        /// <value>The unique id (UUID) of the repository integration</value>
        ...
        /// </summary>
        /// <value>The unique id (UUID) of the app that this repository integration belongs to</value>
        ...
        /// </summary>
        /// <value>User id from the provider</value>
        ...
        {
            return this.Equals(input as AppRepoResponse);
        }

        /// <summary>
        /// Returns true if AppRepoResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of AppRepoResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AppRepoResponse input)
        {
            if (input == null)
                return false;
