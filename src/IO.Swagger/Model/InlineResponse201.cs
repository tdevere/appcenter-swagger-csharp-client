...
namespace IO.Swagger.Model
{
        ...
        public partial class InlineResponse201 :  IEquatable<InlineResponse201>, IValidatableObject
    {
        ...
        public InlineResponse201(Guid? id = default(Guid?), string name = default(string), string displayName = default(string), OriginEnum origin = default(OriginEnum), bool? isPublic = default(bool?))
        {
            ...
            if (origin == null)
            {
                throw new InvalidDataException("origin is a required property for InlineResponse201 and cannot be null");
            }
            else
            {
                this.Origin = origin;
            ...
            if (isPublic == null)
            {
                throw new InvalidDataException("isPublic is a required property for InlineResponse201 and cannot be null");
            }
            else
            {
