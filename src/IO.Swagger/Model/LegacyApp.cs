...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class LegacyApp :  IEquatable<LegacyApp>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="LegacyApp" /> class.
        /// </summary>
        /// <param name="name">The app name..</param>
        /// <param name="collaborators">collaborators.</param>
        /// <param name="deployments">deployments.</param>
        public LegacyApp(string name = default(string), Dictionary<string, LegacyAppListResponseCollaborators> collaborators = default(Dictionary<string, LegacyAppListResponseCollaborators>), List<string> deployments = default(List<string>))
        {
            this.Name = name;
        ...
        {
            return this.Equals(input as LegacyApp);
        }

        /// <summary>
        /// Returns true if LegacyApp instances are equal
        /// </summary>
        /// <param name="input">Instance of LegacyApp to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(LegacyApp input)
        {
            if (input == null)
                return false;
