...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class LogFlowLogContainer :  IEquatable<LogFlowLogContainer>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="LogFlowLogContainer" /> class.
        /// </summary>
        ...
        public LogFlowLogContainer(bool? exceededMaxLimit = default(bool?), DateTime? lastReceivedLogTimestamp = default(DateTime?), List<LogFlowLogContainerLogs> logs = default(List<LogFlowLogContainerLogs>))
        {
            // to ensure "logs" is required (not null)
            if (logs == null)
            {
                throw new InvalidDataException("logs is a required property for LogFlowLogContainer and cannot be null");
            }
            else
            {
                this.Logs = logs;
        ...
        public List<LogFlowLogContainerLogs> Logs { get; set; }
        ...
        {
            return this.Equals(input as LogFlowLogContainer);
        }

        /// <summary>
        /// Returns true if LogFlowLogContainer instances are equal
        /// </summary>
        /// <param name="input">Instance of LogFlowLogContainer to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(LogFlowLogContainer input)
        {
            if (input == null)
                return false;
