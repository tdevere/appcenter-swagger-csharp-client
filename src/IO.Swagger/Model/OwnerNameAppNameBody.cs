...
{
    /// <summary>
    /// OwnerNameAppNameBody
    /// </summary>
    [DataContract]
        public partial class OwnerNameAppNameBody :  IEquatable<OwnerNameAppNameBody>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="OwnerNameAppNameBody" /> class.
        /// </summary>
        ...
        public OwnerNameAppNameBody(string description = default(string), string displayName = default(string), string releaseType = default(string), string name = default(string), string iconUrl = default(string), Guid? iconAssetId = default(Guid?))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class OwnerNameAppNameBody {\n");
        ...
        {
            return this.Equals(input as OwnerNameAppNameBody);
        }

        /// <summary>
        /// Returns true if OwnerNameAppNameBody instances are equal
        /// </summary>
        /// <param name="input">Instance of OwnerNameAppNameBody to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(OwnerNameAppNameBody input)
        {
            if (input == null)
                return false;
