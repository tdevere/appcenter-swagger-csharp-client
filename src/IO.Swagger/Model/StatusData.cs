...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class StatusData :  IEquatable<StatusData>, IValidatableObject
    {
        /// <summary>
        ...
        {
            return this.Equals(input as StatusData);
        }

        /// <summary>
        /// Returns true if StatusData instances are equal
        /// </summary>
        /// <param name="input">Instance of StatusData to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(StatusData input)
        {
            if (input == null)
                return false;
