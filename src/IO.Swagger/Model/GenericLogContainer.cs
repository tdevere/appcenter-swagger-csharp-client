...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class GenericLogContainer :  IEquatable<GenericLogContainer>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="GenericLogContainer" /> class.
        /// </summary>
        ...
        public GenericLogContainer(bool? exceededMaxLimit = default(bool?), DateTime? lastReceivedLogTimestamp = default(DateTime?), List<GenericLogContainerLogs> logs = default(List<GenericLogContainerLogs>))
        {
            // to ensure "logs" is required (not null)
            if (logs == null)
            {
                throw new InvalidDataException("logs is a required property for GenericLogContainer and cannot be null");
            }
            else
            {
                this.Logs = logs;
        ...
        public List<GenericLogContainerLogs> Logs { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class GenericLogContainer {\n");
        ...
        {
            return this.Equals(input as GenericLogContainer);
        }

        /// <summary>
        /// Returns true if GenericLogContainer instances are equal
        /// </summary>
        /// <param name="input">Instance of GenericLogContainer to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GenericLogContainer input)
        {
            if (input == null)
                return false;
