...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class ErrorGroupModel :  IEquatable<ErrorGroupModel>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ErrorGroupModel" /> class.
        /// </summary>
        ...
        {
            return this.Equals(input as ErrorGroupModel);
        }

        /// <summary>
        /// Returns true if ErrorGroupModel instances are equal
        /// </summary>
        /// <param name="input">Instance of ErrorGroupModel to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ErrorGroupModel input)
        {
            if (input == null)
                return false;
