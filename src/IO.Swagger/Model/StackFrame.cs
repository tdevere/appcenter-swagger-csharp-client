...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class StackFrame :  IEquatable<StackFrame>, IValidatableObject
    {
        /// <summary>
        ...
        public StackFrame(string address = default(string), string className = default(string), string method = default(string), bool? classMethod = default(bool?), string file = default(string), int? line = default(int?), bool? appCode = default(bool?), string frameworkName = default(string), string codeRaw = default(string), string codeFormatted = default(string), LanguageEnum? language = default(LanguageEnum?), bool? relevant = default(bool?), string methodParams = default(string))
        {
            // to ensure "appCode" is required (not null)
            if (appCode == null)
            {
                throw new InvalidDataException("appCode is a required property for StackFrame and cannot be null");
            }
            else
            {
            ...
            if (codeRaw == null)
            {
                throw new InvalidDataException("codeRaw is a required property for StackFrame and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("codeFormatted is a required property for StackFrame and cannot be null");
            }
            else
            {
        ...
        {
            return this.Equals(input as StackFrame);
        }

        /// <summary>
        /// Returns true if StackFrame instances are equal
        /// </summary>
        /// <param name="input">Instance of StackFrame to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(StackFrame input)
        {
            if (input == null)
                return false;
