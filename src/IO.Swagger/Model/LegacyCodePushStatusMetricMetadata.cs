...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class LegacyCodePushStatusMetricMetadata :  IEquatable<LegacyCodePushStatusMetricMetadata>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="LegacyCodePushStatusMetricMetadata" /> class.
        /// </summary>
        ...
        public LegacyCodePushStatusMetricMetadata(string deploymentKey = default(string), string label = default(string), string appVersion = default(string), string previousDeploymentKey = default(string), string previousLabelOrAppVersion = default(string), string status = default(string), string clientUniqueId = default(string))
        {
        ...
        {
            return this.Equals(input as LegacyCodePushStatusMetricMetadata);
        }

        /// <summary>
        /// Returns true if LegacyCodePushStatusMetricMetadata instances are equal
        /// </summary>
        /// <param name="input">Instance of LegacyCodePushStatusMetricMetadata to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(LegacyCodePushStatusMetricMetadata input)
        {
            if (input == null)
                return false;
