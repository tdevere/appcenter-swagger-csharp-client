...
namespace IO.Swagger.Model
{
    ...
    [JsonConverter(typeof(JsonSubtypes), "type")]
        public partial class AppNameExportConfigurationsBody :  IEquatable<AppNameExportConfigurationsBody>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="AppNameExportConfigurationsBody" /> class.
        /// </summary>
        ...
        public AppNameExportConfigurationsBody(TypeEnum type = default(TypeEnum), List<ExportEntitiesEnum> exportEntities = default(List<ExportEntitiesEnum>), string resourceName = default(string), string resourceGroup = default(string), bool? backfill = default(bool?))
        {
            // to ensure "type" is required (not null)
            if (type == null)
            {
                throw new InvalidDataException("type is a required property for AppNameExportConfigurationsBody and cannot be null");
            }
            else
            {
                this.Type = type;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class AppNameExportConfigurationsBody {\n");
        ...
        {
            return this.Equals(input as AppNameExportConfigurationsBody);
        }

        /// <summary>
        /// Returns true if AppNameExportConfigurationsBody instances are equal
        /// </summary>
        /// <param name="input">Instance of AppNameExportConfigurationsBody to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AppNameExportConfigurationsBody input)
        {
            if (input == null)
                return false;
