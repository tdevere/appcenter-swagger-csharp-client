...
namespace IO.Swagger.Model
{
        ...
        public partial class AppResponse :  IEquatable<AppResponse>, IValidatableObject
    {
        ...
        public AppResponse(string appSecret = default(string), InlineResponse20011 azureSubscription = default(InlineResponse20011), PlatformEnum? platform = default(PlatformEnum?), OriginEnum? origin = default(OriginEnum?), string createdAt = default(string), string updatedAt = default(string), List<MemberPermissionsEnum> memberPermissions = default(List<MemberPermissionsEnum>))
        {
        ...
        public InlineResponse20011 AzureSubscription { get; set; }
        ...
        {
            return this.Equals(input as AppResponse);
        }

        /// <summary>
        /// Returns true if AppResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of AppResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AppResponse input)
        {
            if (input == null)
                return false;
