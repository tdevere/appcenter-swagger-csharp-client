...
namespace IO.Swagger.Model
{
        ...
        public partial class ErrorDetails :  IEquatable<ErrorDetails>, IValidatableObject
    {
        ...
        public ErrorDetails(CodeEnum code = default(CodeEnum), string message = default(string))
        {
            // to ensure "code" is required (not null)
            if (code == null)
            {
                throw new InvalidDataException("code is a required property for ErrorDetails and cannot be null");
            }
            else
            {
                this.Code = code;
            ...
            if (message == null)
            {
                throw new InvalidDataException("message is a required property for ErrorDetails and cannot be null");
            }
            else
            {
