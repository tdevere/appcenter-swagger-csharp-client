...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class ErrorAttachment :  IEquatable<ErrorAttachment>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ErrorAttachment" /> class.
        /// </summary>
        ...
        public ErrorAttachment(string appId = default(string), string attachmentId = default(string), string crashId = default(string), string blobLocation = default(string), string contentType = default(string), string fileName = default(string), DateTime? createdTime = default(DateTime?), long? size = default(long?))
        {
            this.AppId = appId;
        ...
        {
            return this.Equals(input as ErrorAttachment);
        }

        /// <summary>
        /// Returns true if ErrorAttachment instances are equal
        /// </summary>
        /// <param name="input">Instance of ErrorAttachment to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ErrorAttachment input)
        {
            if (input == null)
                return false;
