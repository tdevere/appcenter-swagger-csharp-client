...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class AppNameAppleMappingBody :  IEquatable<AppNameAppleMappingBody>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="AppNameAppleMappingBody" /> class.
        /// </summary>
        ...
        public AppNameAppleMappingBody(string serviceConnectionId = default(string), string appleId = default(string), string bundleIdentifier = default(string), string teamIdentifier = default(string))
        {
            // to ensure "serviceConnectionId" is required (not null)
            if (serviceConnectionId == null)
            {
                throw new InvalidDataException("serviceConnectionId is a required property for AppNameAppleMappingBody and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("teamIdentifier is a required property for AppNameAppleMappingBody and cannot be null");
            }
            else
            {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class AppNameAppleMappingBody {\n");
        ...
        {
            return this.Equals(input as AppNameAppleMappingBody);
        }

        /// <summary>
        /// Returns true if AppNameAppleMappingBody instances are equal
        /// </summary>
        /// <param name="input">Instance of AppNameAppleMappingBody to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AppNameAppleMappingBody input)
        {
            if (input == null)
                return false;
