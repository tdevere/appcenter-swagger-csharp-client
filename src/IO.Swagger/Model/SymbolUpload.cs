...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class SymbolUpload :  IEquatable<SymbolUpload>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="SymbolUpload" /> class.
        /// </summary>
        ...
        public SymbolUpload(string symbolUploadId = default(string), string appId = default(string), V01appsownerNameappNamesymbolUploadsUser user = default(V01appsownerNameappNamesymbolUploadsUser), StatusEnum status = default(StatusEnum), SymbolTypeEnum symbolType = default(SymbolTypeEnum), List<V01appsownerNameappNamesymbolUploadsSymbolsUploaded> symbolsUploaded = default(List<V01appsownerNameappNamesymbolUploadsSymbolsUploaded>), OriginEnum? origin = default(OriginEnum?), string fileName = default(string), decimal? fileSize = default(decimal?), DateTime? timestamp = default(DateTime?))
        {
            // to ensure "symbolUploadId" is required (not null)
            if (symbolUploadId == null)
            {
                throw new InvalidDataException("symbolUploadId is a required property for SymbolUpload and cannot be null");
            }
            else
            {
            ...
            if (appId == null)
            {
                throw new InvalidDataException("appId is a required property for SymbolUpload and cannot be null");
            }
            else
            {
                this.AppId = appId;
            ...
            if (status == null)
            {
                throw new InvalidDataException("status is a required property for SymbolUpload and cannot be null");
            }
            else
            {
                this.Status = status;
            ...
            if (symbolType == null)
            {
                throw new InvalidDataException("symbolType is a required property for SymbolUpload and cannot be null");
            }
            else
            {
        ...
        public V01appsownerNameappNamesymbolUploadsUser User { get; set; }
        ...
        public List<V01appsownerNameappNamesymbolUploadsSymbolsUploaded> SymbolsUploaded { get; set; }
        ...
        {
            return this.Equals(input as SymbolUpload);
        }

        /// <summary>
        /// Returns true if SymbolUpload instances are equal
        /// </summary>
        /// <param name="input">Instance of SymbolUpload to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SymbolUpload input)
        {
            if (input == null)
                return false;
