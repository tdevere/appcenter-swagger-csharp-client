...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class PostCreateReleaseUploadRequest :  IEquatable<PostCreateReleaseUploadRequest>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PostCreateReleaseUploadRequest" /> class.
        /// </summary>
        /// <param name="buildVersion">User defined build version.</param>
        /// <param name="buildNumber">User defined build number.</param>
        public PostCreateReleaseUploadRequest(string buildVersion = default(string), string buildNumber = default(string))
        {
        ...
        {
            return this.Equals(input as PostCreateReleaseUploadRequest);
        }

        /// <summary>
        /// Returns true if PostCreateReleaseUploadRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of PostCreateReleaseUploadRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PostCreateReleaseUploadRequest input)
        {
            if (input == null)
                return false;
