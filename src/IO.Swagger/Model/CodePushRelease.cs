...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class CodePushRelease :  IEquatable<CodePushRelease>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="CodePushRelease" /> class.
        /// </summary>
        ...
        public CodePushRelease(string label = default(string), string packageHash = default(string), string blobUrl = default(string), Dictionary<string, CodePushReleaseDiffPackageMap> diffPackageMap = default(Dictionary<string, CodePushReleaseDiffPackageMap>), string originalDeployment = default(string), string originalLabel = default(string), string releasedBy = default(string), ReleaseMethodEnum? releaseMethod = default(ReleaseMethodEnum?), decimal? size = default(decimal?), int? uploadTime = default(int?))
        {
            this.Label = label;
        ...
        public Dictionary<string, CodePushReleaseDiffPackageMap> DiffPackageMap { get; set; }
        ...
        {
            return this.Equals(input as CodePushRelease);
        }

        /// <summary>
        /// Returns true if CodePushRelease instances are equal
        /// </summary>
        /// <param name="input">Instance of CodePushRelease to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CodePushRelease input)
        {
            if (input == null)
                return false;
