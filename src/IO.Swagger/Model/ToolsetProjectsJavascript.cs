...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class ToolsetProjectsJavascript :  IEquatable<ToolsetProjectsJavascript>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ToolsetProjectsJavascript" /> class.
        /// </summary>
        ...
        public ToolsetProjectsJavascript(List<string> packageJsonPaths = default(List<string>), List<JavaScriptToolsetJavascriptSolutions> javascriptSolutions = default(List<JavaScriptToolsetJavascriptSolutions>))
        {
            // to ensure "packageJsonPaths" is required (not null)
            if (packageJsonPaths == null)
            {
                throw new InvalidDataException("packageJsonPaths is a required property for ToolsetProjectsJavascript and cannot be null");
            }
            else
            {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ToolsetProjectsJavascript {\n");
        ...
        {
            return this.Equals(input as ToolsetProjectsJavascript);
        }

        /// <summary>
        /// Returns true if ToolsetProjectsJavascript instances are equal
        /// </summary>
        /// <param name="input">Instance of ToolsetProjectsJavascript to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ToolsetProjectsJavascript input)
        {
            if (input == null)
                return false;
