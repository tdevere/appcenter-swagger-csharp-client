...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class AutoProvisioningConfigResponse :  IEquatable<AutoProvisioningConfigResponse>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="AutoProvisioningConfigResponse" /> class.
        /// </summary>
        /// <param name="id">The identifier of the config..</param>
        /// <param name="appId">The identifier of the App..</param>
        /// <param name="destinationId">The identifier of the destination..</param>
        ...
        /// <param name="appleDistributionCertificateKey">A key to a secret in customer-credential-store. distribution_certificate refers to the cusomer&#x27;s certificate (that holds the private key) that will be used to sign the app..</param>
        /// <param name="allowAutoProvisioning">When *true* enables auto provisioning.</param>
        public AutoProvisioningConfigResponse(decimal? id = default(decimal?), string appId = default(string), string destinationId = default(string), string appleDeveloperAccountKey = default(string), string appleDistributionCertificateKey = default(string), bool? allowAutoProvisioning = default(bool?))
        {
            this.Id = id;
            this.AppId = appId;
        ...
        /// </summary>
        /// <value>The identifier of the App.</value>
        ...
        /// </summary>
        /// <value>The identifier of the destination.</value>
        ...
        /// </summary>
        /// <value>A key to a secret in customer-credential-store. distribution_certificate refers to the cusomer&#x27;s certificate (that holds the private key) that will be used to sign the app.</value>
        ...
        {
            return this.Equals(input as AutoProvisioningConfigResponse);
        }

        /// <summary>
        /// Returns true if AutoProvisioningConfigResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of AutoProvisioningConfigResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AutoProvisioningConfigResponse input)
        {
            if (input == null)
                return false;
