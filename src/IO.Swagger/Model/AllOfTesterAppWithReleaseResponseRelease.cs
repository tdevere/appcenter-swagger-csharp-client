...
{
    /// <summary>
    /// AllOfTesterAppWithReleaseResponseRelease
    /// </summary>
    [DataContract]
        public partial class AllOfTesterAppWithReleaseResponseRelease :  IEquatable<AllOfTesterAppWithReleaseResponseRelease>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="AllOfTesterAppWithReleaseResponseRelease" /> class.
        /// </summary>
        ...
        public AllOfTesterAppWithReleaseResponseRelease(int? size = default(int?), string installUrl = default(string), string releaseNotes = default(string))
        {
            // to ensure "size" is required (not null)
            if (size == null)
            {
                throw new InvalidDataException("size is a required property for AllOfTesterAppWithReleaseResponseRelease and cannot be null");
            }
            else
            {
                this.Size = size;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class AllOfTesterAppWithReleaseResponseRelease {\n");
        ...
        {
            return this.Equals(input as AllOfTesterAppWithReleaseResponseRelease);
        }

        /// <summary>
        /// Returns true if AllOfTesterAppWithReleaseResponseRelease instances are equal
        /// </summary>
        /// <param name="input">Instance of AllOfTesterAppWithReleaseResponseRelease to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AllOfTesterAppWithReleaseResponseRelease input)
        {
            if (input == null)
                return false;
