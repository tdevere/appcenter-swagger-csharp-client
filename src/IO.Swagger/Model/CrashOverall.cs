...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class CrashOverall :  IEquatable<CrashOverall>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CrashOverall" /> class.
        /// </summary>
        ...
        {
            return this.Equals(input as CrashOverall);
        }

        /// <summary>
        /// Returns true if CrashOverall instances are equal
        /// </summary>
        /// <param name="input">Instance of CrashOverall to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CrashOverall input)
        {
            if (input == null)
                return false;
