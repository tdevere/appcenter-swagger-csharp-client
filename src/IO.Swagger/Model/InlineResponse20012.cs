...
namespace IO.Swagger.Model
{
        ...
        public partial class InlineResponse20012 :  IEquatable<InlineResponse20012>, IValidatableObject
    {
        ...
        public InlineResponse20012(string version = default(string), string timestamp = default(string), string id = default(string), AggregatedBillingInformationBillingPlans billingPlans = default(AggregatedBillingInformationBillingPlans), AggregatedBillingInformationUsage usage = default(AggregatedBillingInformationUsage), string azureSubscriptionId = default(string), AzureSubscriptionStateEnum? azureSubscriptionState = default(AzureSubscriptionStateEnum?))
        {
