...
namespace IO.Swagger.Model
{
        ...
        public partial class InlineResponse20038 :  IEquatable<InlineResponse20038>, IValidatableObject
    {
        ...
        public InlineResponse20038(bool? exceededMaxLimit = default(bool?), DateTime? lastReceivedLogTimestamp = default(DateTime?), List<GenericLogContainerDiagnosticsLogs> logs = default(List<GenericLogContainerDiagnosticsLogs>))
        {
            // to ensure "logs" is required (not null)
            if (logs == null)
            {
                throw new InvalidDataException("logs is a required property for InlineResponse20038 and cannot be null");
            }
            else
            {
                this.Logs = logs;
