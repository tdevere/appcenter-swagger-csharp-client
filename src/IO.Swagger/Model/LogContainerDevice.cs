...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class LogContainerDevice :  IEquatable<LogContainerDevice>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="LogContainerDevice" /> class.
        /// </summary>
        ...
        public LogContainerDevice(string sdkName = default(string), string sdkVersion = default(string), string wrapperSdkVersion = default(string), string wrapperSdkName = default(string), string model = default(string), string oemName = default(string), string osName = default(string), string osVersion = default(string), string osBuild = default(string), int? osApiLevel = default(int?), string locale = default(string), int? timeZoneOffset = default(int?), string screenSize = default(string), string appVersion = default(string), string carrierName = default(string), string carrierCode = default(string), string carrierCountry = default(string), string appBuild = default(string), string appNamespace = default(string), string liveUpdateReleaseLabel = default(string), string liveUpdateDeploymentKey = default(string), string liveUpdatePackageHash = default(string), string wrapperRuntimeVersion = default(string))
        {
            ...
            if (sdkVersion == null)
            {
                throw new InvalidDataException("sdkVersion is a required property for LogContainerDevice and cannot be null");
            }
            else
            {
            ...
            if (osName == null)
            {
                throw new InvalidDataException("osName is a required property for LogContainerDevice and cannot be null");
            }
            else
            {
                this.OsName = osName;
            ...
            if (osVersion == null)
            {
                throw new InvalidDataException("osVersion is a required property for LogContainerDevice and cannot be null");
            }
            else
            {
            ...
            if (locale == null)
            {
                throw new InvalidDataException("locale is a required property for LogContainerDevice and cannot be null");
            }
            else
            {
                this.Locale = locale;
            ...
            {
                throw new InvalidDataException("timeZoneOffset is a required property for LogContainerDevice and cannot be null");
            }
            else
            {
            ...
            if (appVersion == null)
            {
                throw new InvalidDataException("appVersion is a required property for LogContainerDevice and cannot be null");
            }
            else
            {
            ...
            if (appBuild == null)
            {
                throw new InvalidDataException("appBuild is a required property for LogContainerDevice and cannot be null");
            }
            else
            {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class LogContainerDevice {\n");
        ...
        {
            return this.Equals(input as LogContainerDevice);
        }

        /// <summary>
        /// Returns true if LogContainerDevice instances are equal
        /// </summary>
        /// <param name="input">Instance of LogContainerDevice to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(LogContainerDevice input)
        {
            if (input == null)
                return false;
