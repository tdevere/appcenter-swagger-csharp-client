...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class UsagePeriod :  IEquatable<UsagePeriod>, IValidatableObject
    {
        /// <summary>
        ...
        public UsagePeriod(string startTime = default(string), string endTime = default(string), Dictionary<string, decimal?> byAccount = default(Dictionary<string, decimal?>), Dictionary<string, Dictionary<string, decimal?>> byApp = default(Dictionary<string, Dictionary<string, decimal?>>))
        {
        ...
        {
            return this.Equals(input as UsagePeriod);
        }

        /// <summary>
        /// Returns true if UsagePeriod instances are equal
        /// </summary>
        /// <param name="input">Instance of UsagePeriod to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(UsagePeriod input)
        {
            if (input == null)
                return false;
