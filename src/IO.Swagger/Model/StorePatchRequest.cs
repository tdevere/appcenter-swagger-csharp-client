...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class StorePatchRequest :  IEquatable<StorePatchRequest>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="StorePatchRequest" /> class.
        /// </summary>
        /// <param name="serviceConnectionId">Service connection id to updated. (required).</param>
        public StorePatchRequest(string serviceConnectionId = default(string))
        {
            // to ensure "serviceConnectionId" is required (not null)
            if (serviceConnectionId == null)
            {
                throw new InvalidDataException("serviceConnectionId is a required property for StorePatchRequest and cannot be null");
            }
            else
            {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class StorePatchRequest {\n");
        ...
        {
            return this.Equals(input as StorePatchRequest);
        }

        /// <summary>
        /// Returns true if StorePatchRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of StorePatchRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(StorePatchRequest input)
        {
            if (input == null)
                return false;
