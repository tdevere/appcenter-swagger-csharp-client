...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class XcodeSchemeContainer :  IEquatable<XcodeSchemeContainer>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="XcodeSchemeContainer" /> class.
        /// </summary>
        ...
        public XcodeSchemeContainer(string path = default(string), List<XcodeToolsetSharedSchemes> sharedSchemes = default(List<XcodeToolsetSharedSchemes>), string podfilePath = default(string), string cartfilePath = default(string), string xcodeProjectSha = default(string), string workspaceProjectPaths = default(string), List<XcodeToolsetAppExtensionTargets> appExtensionTargets = default(List<XcodeToolsetAppExtensionTargets>))
        {
            // to ensure "path" is required (not null)
            if (path == null)
            {
                throw new InvalidDataException("path is a required property for XcodeSchemeContainer and cannot be null");
            }
            else
            {
                this.Path = path;
            ...
            {
                throw new InvalidDataException("sharedSchemes is a required property for XcodeSchemeContainer and cannot be null");
            }
            else
            {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class XcodeSchemeContainer {\n");
        ...
        {
            return this.Equals(input as XcodeSchemeContainer);
        }

        /// <summary>
        /// Returns true if XcodeSchemeContainer instances are equal
        /// </summary>
        /// <param name="input">Instance of XcodeSchemeContainer to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(XcodeSchemeContainer input)
        {
            if (input == null)
                return false;
