...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class DistributionRequest :  IEquatable<DistributionRequest>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="DistributionRequest" /> class.
        /// </summary>
        ...
        public DistributionRequest(List<V01appsownerNameappNamebuildsbuildIddistributeDestinations> destinations = default(List<V01appsownerNameappNamebuildsbuildIddistributeDestinations>), string releaseNotes = default(string), bool? mandatoryUpdate = default(bool?), bool? notifyTesters = true)
        {
        ...
        {
            return this.Equals(input as DistributionRequest);
        }

        /// <summary>
        /// Returns true if DistributionRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of DistributionRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(DistributionRequest input)
        {
            if (input == null)
                return false;
