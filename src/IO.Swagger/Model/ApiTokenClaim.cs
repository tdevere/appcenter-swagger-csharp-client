...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class ApiTokenClaim :  IEquatable<ApiTokenClaim>, IValidatableObject
    {
        /// <summary>
        /// Defines ClaimType
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="ApiTokenClaim" /> class.
        /// </summary>
        /// <param name="claimType">claimType.</param>
        /// <param name="claimValue">claimValue.</param>
        public ApiTokenClaim(ClaimTypeEnum? claimType = default(ClaimTypeEnum?), string claimValue = default(string))
        {
        ...
        {
            return this.Equals(input as ApiTokenClaim);
        }

        /// <summary>
        /// Returns true if ApiTokenClaim instances are equal
        /// </summary>
        /// <param name="input">Instance of ApiTokenClaim to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ApiTokenClaim input)
        {
            if (input == null)
                return false;
