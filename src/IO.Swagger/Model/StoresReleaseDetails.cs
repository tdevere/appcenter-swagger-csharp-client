...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class StoresReleaseDetails :  IEquatable<StoresReleaseDetails>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="StoresReleaseDetails" /> class.
        /// </summary>
        ...
        public StoresReleaseDetails(decimal? id = default(decimal?), StatusEnum? status = default(StatusEnum?), string appName = default(string), string appDisplayName = default(string), string version = default(string), string shortVersion = default(string), string releaseNotes = default(string), decimal? size = default(decimal?), string minOs = default(string), string androidMinApiLevel = default(string), string bundleIdentifier = default(string), string fingerprint = default(string), string uploadedAt = default(string), string downloadUrl = default(string), InstallUrlEnum? installUrl = default(InstallUrlEnum?), List<V01appsownerNameappNamedistributionStoresstoreNamereleasesreleaseIdDistributionStores> distributionStores = default(List<V01appsownerNameappNamedistributionStoresstoreNamereleasesreleaseIdDistributionStores>))
        {
            this.Id = id;
            this.Status = status;
        ...
        {
            return this.Equals(input as StoresReleaseDetails);
        }

        /// <summary>
        /// Returns true if StoresReleaseDetails instances are equal
        /// </summary>
        /// <param name="input">Instance of StoresReleaseDetails to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(StoresReleaseDetails input)
        {
            if (input == null)
                return false;
