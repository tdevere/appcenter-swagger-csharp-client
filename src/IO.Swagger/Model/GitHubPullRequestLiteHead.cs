...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class GitHubPullRequestLiteHead :  IEquatable<GitHubPullRequestLiteHead>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="GitHubPullRequestLiteHead" /> class.
        /// </summary>
        /// <param name="_ref">The repository name.</param>
        /// <param name="sha">The discription of repository.</param>
        /// <param name="repo">repo.</param>
        public GitHubPullRequestLiteHead(string _ref = default(string), string sha = default(string), GitHubPullRequestLiteHeadRepo repo = default(GitHubPullRequestLiteHeadRepo))
        {
            this._Ref = _ref;
            this.Sha = sha;
            this.Repo = repo;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class GitHubPullRequestLiteHead {\n");
        ...
        {
            return this.Equals(input as GitHubPullRequestLiteHead);
        }

        /// <summary>
        /// Returns true if GitHubPullRequestLiteHead instances are equal
        /// </summary>
        /// <param name="input">Instance of GitHubPullRequestLiteHead to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GitHubPullRequestLiteHead input)
        {
            if (input == null)
                return false;
