...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class LogContainer :  IEquatable<LogContainer>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="LogContainer" /> class.
        /// </summary>
        ...
        public LogContainer(bool? exceededMaxLimit = default(bool?), DateTime? lastReceivedLogTimestamp = default(DateTime?), List<LogContainerLogs> logs = default(List<LogContainerLogs>))
        {
            // to ensure "logs" is required (not null)
            if (logs == null)
            {
                throw new InvalidDataException("logs is a required property for LogContainer and cannot be null");
            }
            else
            {
                this.Logs = logs;
        ...
        public List<LogContainerLogs> Logs { get; set; }
        ...
        {
            return this.Equals(input as LogContainer);
        }

        /// <summary>
        /// Returns true if LogContainer instances are equal
        /// </summary>
        /// <param name="input">Instance of LogContainer to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(LogContainer input)
        {
            if (input == null)
                return false;
