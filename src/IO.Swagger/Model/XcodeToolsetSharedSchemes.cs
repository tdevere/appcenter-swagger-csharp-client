...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class XcodeToolsetSharedSchemes :  IEquatable<XcodeToolsetSharedSchemes>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="XcodeToolsetSharedSchemes" /> class.
        /// </summary>
        ...
        public XcodeToolsetSharedSchemes(string name = default(string), bool? hasTestAction = default(bool?), string archiveConfiguration = default(string), XcodeSchemeArchiveProject archiveProject = default(XcodeSchemeArchiveProject))
        {
            // to ensure "name" is required (not null)
            if (name == null)
            {
                throw new InvalidDataException("name is a required property for XcodeToolsetSharedSchemes and cannot be null");
            }
            else
            {
                this.Name = name;
            ...
            {
                throw new InvalidDataException("hasTestAction is a required property for XcodeToolsetSharedSchemes and cannot be null");
            }
            else
            {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class XcodeToolsetSharedSchemes {\n");
        ...
        {
            return this.Equals(input as XcodeToolsetSharedSchemes);
        }

        /// <summary>
        /// Returns true if XcodeToolsetSharedSchemes instances are equal
        /// </summary>
        /// <param name="input">Instance of XcodeToolsetSharedSchemes to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(XcodeToolsetSharedSchemes input)
        {
            if (input == null)
                return false;
