...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class CrashGroupModel :  IEquatable<CrashGroupModel>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CrashGroupModel" /> class.
        /// </summary>
        ...
        {
            return this.Equals(input as CrashGroupModel);
        }

        /// <summary>
        /// Returns true if CrashGroupModel instances are equal
        /// </summary>
        /// <param name="input">Instance of CrashGroupModel to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CrashGroupModel input)
        {
            if (input == null)
                return false;
