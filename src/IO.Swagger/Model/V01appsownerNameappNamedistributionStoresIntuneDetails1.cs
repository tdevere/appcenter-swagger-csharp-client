...
{
    /// <summary>
    /// V01appsownerNameappNamedistributionStoresIntuneDetails1
    /// </summary>
    [DataContract]
        public partial class V01appsownerNameappNamedistributionStoresIntuneDetails1 :  IEquatable<V01appsownerNameappNamedistributionStoresIntuneDetails1>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="V01appsownerNameappNamedistributionStoresIntuneDetails1" /> class.
        /// </summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class V01appsownerNameappNamedistributionStoresIntuneDetails1 {\n");
        ...
        {
            return this.Equals(input as V01appsownerNameappNamedistributionStoresIntuneDetails1);
        }

        /// <summary>
        /// Returns true if V01appsownerNameappNamedistributionStoresIntuneDetails1 instances are equal
        /// </summary>
        /// <param name="input">Instance of V01appsownerNameappNamedistributionStoresIntuneDetails1 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(V01appsownerNameappNamedistributionStoresIntuneDetails1 input)
        {
            if (input == null)
                return false;
