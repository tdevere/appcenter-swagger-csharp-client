...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class CreateAccessKeyResponseAccessKey :  IEquatable<CreateAccessKeyResponseAccessKey>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CreateAccessKeyResponseAccessKey" /> class.
        /// </summary>
        ...
        public CreateAccessKeyResponseAccessKey(string name = default(string), string createdBy = default(string), string description = default(string), string friendlyName = default(string), decimal? createdTime = default(decimal?), decimal? expires = default(decimal?), string id = default(string), bool? isSession = default(bool?))
        {
            this.Name = name;
        ...
        {
            return this.Equals(input as CreateAccessKeyResponseAccessKey);
        }

        /// <summary>
        /// Returns true if CreateAccessKeyResponseAccessKey instances are equal
        /// </summary>
        /// <param name="input">Instance of CreateAccessKeyResponseAccessKey to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CreateAccessKeyResponseAccessKey input)
        {
            if (input == null)
                return false;
