...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class EventDeviceCount :  IEquatable<EventDeviceCount>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="EventDeviceCount" /> class.
        /// </summary>
        ...
        public EventDeviceCount(long? totalDevices = default(long?), long? totalDevicesWithEvent = default(long?), long? previousTotalDevicesWithEvent = default(long?), List<InlineResponse20078> devicesCount = default(List<InlineResponse20078>))
        {
        ...
        {
            return this.Equals(input as EventDeviceCount);
        }

        /// <summary>
        /// Returns true if EventDeviceCount instances are equal
        /// </summary>
        /// <param name="input">Instance of EventDeviceCount to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(EventDeviceCount input)
        {
            if (input == null)
                return false;
