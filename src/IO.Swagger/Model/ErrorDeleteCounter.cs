...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class ErrorDeleteCounter :  IEquatable<ErrorDeleteCounter>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ErrorDeleteCounter" /> class.
        /// </summary>
        ...
        public ErrorDeleteCounter(string appId = default(string), string errorGroupId = default(string), string errorId = default(string), int? errorsDeleted = default(int?), int? attachmentsDeleted = default(int?), int? blobsSucceeded = default(int?), int? blobsFailed = default(int?))
        {
            this.AppId = appId;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ErrorDeleteCounter {\n");
        ...
        {
            return this.Equals(input as ErrorDeleteCounter);
        }

        /// <summary>
        /// Returns true if ErrorDeleteCounter instances are equal
        /// </summary>
        /// <param name="input">Instance of ErrorDeleteCounter to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ErrorDeleteCounter input)
        {
            if (input == null)
                return false;
