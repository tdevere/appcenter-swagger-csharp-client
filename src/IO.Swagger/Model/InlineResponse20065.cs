...
namespace IO.Swagger.Model
{
        ...
        public partial class InlineResponse20065 :  IEquatable<InlineResponse20065>, IValidatableObject
    {
        ...
        public InlineResponse20065(bool? exceededMaxLimit = default(bool?), DateTime? lastReceivedLogTimestamp = default(DateTime?), List<GenericLogContainerLogs> logs = default(List<GenericLogContainerLogs>))
        {
            // to ensure "logs" is required (not null)
            if (logs == null)
            {
                throw new InvalidDataException("logs is a required property for InlineResponse20065 and cannot be null");
            }
            else
            {
                this.Logs = logs;
