...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class ReleaseDestinationRequest :  IEquatable<ReleaseDestinationRequest>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ReleaseDestinationRequest" /> class.
        /// </summary>
        ...
        public ReleaseDestinationRequest(bool? mandatoryUpdate = default(bool?), bool? notifyTesters = true)
        {
        ...
        {
            return this.Equals(input as ReleaseDestinationRequest);
        }

        /// <summary>
        /// Returns true if ReleaseDestinationRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of ReleaseDestinationRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ReleaseDestinationRequest input)
        {
            if (input == null)
                return false;
