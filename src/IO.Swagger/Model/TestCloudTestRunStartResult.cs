...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class TestCloudTestRunStartResult :  IEquatable<TestCloudTestRunStartResult>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TestCloudTestRunStartResult" /> class.
        /// </summary>
        ...
        public TestCloudTestRunStartResult(List<string> acceptedDevices = default(List<string>), List<string> rejectedDevices = default(List<string>))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TestCloudTestRunStartResult {\n");
        ...
        {
            return this.Equals(input as TestCloudTestRunStartResult);
        }

        /// <summary>
        /// Returns true if TestCloudTestRunStartResult instances are equal
        /// </summary>
        /// <param name="input">Instance of TestCloudTestRunStartResult to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TestCloudTestRunStartResult input)
        {
            if (input == null)
                return false;
