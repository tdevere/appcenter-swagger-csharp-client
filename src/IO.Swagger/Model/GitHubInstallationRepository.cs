...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class GitHubInstallationRepository :  IEquatable<GitHubInstallationRepository>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="GitHubInstallationRepository" /> class.
        /// </summary>
        ...
        public GitHubInstallationRepository(string name = default(string), string description = default(string), string cloneUrl = default(string), string defaultBranch = default(string), string language = default(string), string updatedAt = default(string), bool? fork = default(bool?))
        {
            this.Name = name;
        ...
        {
            return this.Equals(input as GitHubInstallationRepository);
        }

        /// <summary>
        /// Returns true if GitHubInstallationRepository instances are equal
        /// </summary>
        /// <param name="input">Instance of GitHubInstallationRepository to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GitHubInstallationRepository input)
        {
            if (input == null)
                return false;
