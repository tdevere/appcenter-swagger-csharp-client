...
namespace IO.Swagger.Model
{
        ...
        public partial class BillingPlan :  IEquatable<BillingPlan>, IValidatableObject
    {
        ...
        public BillingPlan(string id = default(string), string version = default(string), decimal? price = default(decimal?), PaymentSourceEnum? paymentSource = default(PaymentSourceEnum?), ServiceEnum? service = default(ServiceEnum?), Dictionary<string, decimal?> limits = default(Dictionary<string, decimal?>), Dictionary<string, Object> attributes = default(Dictionary<string, Object>), string parentId = default(string))
        {
            this.Id = id;
        ...
        {
            return this.Equals(input as BillingPlan);
        }

        /// <summary>
        /// Returns true if BillingPlan instances are equal
        /// </summary>
        /// <param name="input">Instance of BillingPlan to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(BillingPlan input)
        {
            if (input == null)
                return false;
