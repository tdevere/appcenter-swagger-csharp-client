...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class LegacyAccount :  IEquatable<LegacyAccount>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="LegacyAccount" /> class.
        /// </summary>
        ...
        public LegacyAccount(string name = default(string), string email = default(string), List<string> linkedProviders = default(List<string>))
        {
            this.Name = name;
            this.Email = email;
        ...
        {
            return this.Equals(input as LegacyAccount);
        }

        /// <summary>
        /// Returns true if LegacyAccount instances are equal
        /// </summary>
        /// <param name="input">Instance of LegacyAccount to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(LegacyAccount input)
        {
            if (input == null)
                return false;
