...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class SessionsPerDevice :  IEquatable<SessionsPerDevice>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SessionsPerDevice" /> class.
        /// </summary>
        ...
        public SessionsPerDevice(double? averageSessionsPerUser = default(double?), double? previousAverageSessionsPerUser = default(double?), long? totalCount = default(long?), long? previousTotalCount = default(long?), List<SessionsPerDeviceSessionsPerUser> sessionsPerUser = default(List<SessionsPerDeviceSessionsPerUser>))
        {
        ...
        {
            return this.Equals(input as SessionsPerDevice);
        }

        /// <summary>
        /// Returns true if SessionsPerDevice instances are equal
        /// </summary>
        /// <param name="input">Instance of SessionsPerDevice to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SessionsPerDevice input)
        {
            if (input == null)
                return false;
