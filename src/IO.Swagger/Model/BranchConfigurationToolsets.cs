...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class BranchConfigurationToolsets :  IEquatable<BranchConfigurationToolsets>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="BranchConfigurationToolsets" /> class.
        /// </summary>
        ...
        {
            return this.Equals(input as BranchConfigurationToolsets);
        }

        /// <summary>
        /// Returns true if BranchConfigurationToolsets instances are equal
        /// </summary>
        /// <param name="input">Instance of BranchConfigurationToolsets to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(BranchConfigurationToolsets input)
        {
            if (input == null)
                return false;
