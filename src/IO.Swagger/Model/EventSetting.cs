...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class EventSetting :  IEquatable<EventSetting>, IValidatableObject
    {
        /// <summary>
        /// Event Name
        /// </summary>
        ...
        public EventSetting(EventTypeEnum eventType = default(EventTypeEnum), ValueEnum value = default(ValueEnum), DefaultValueEnum? defaultValue = default(DefaultValueEnum?))
        {
            // to ensure "eventType" is required (not null)
            if (eventType == null)
            {
                throw new InvalidDataException("eventType is a required property for EventSetting and cannot be null");
            }
            else
            {
            ...
            if (value == null)
            {
                throw new InvalidDataException("value is a required property for EventSetting and cannot be null");
            }
            else
            {
                this.Value = value;
        ...
        {
            return this.Equals(input as EventSetting);
        }

        /// <summary>
        /// Returns true if EventSetting instances are equal
        /// </summary>
        /// <param name="input">Instance of EventSetting to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(EventSetting input)
        {
            if (input == null)
                return false;
