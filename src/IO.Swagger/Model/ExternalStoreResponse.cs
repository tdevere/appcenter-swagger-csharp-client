...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class ExternalStoreResponse :  IEquatable<ExternalStoreResponse>, IValidatableObject
    {
        /// <summary>
        /// Store track
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="ExternalStoreResponse" /> class.
        /// </summary>
        ...
        public ExternalStoreResponse(string id = default(string), string name = default(string), string type = default(string), TrackEnum? track = default(TrackEnum?), ExternalStoreResponseIntuneDetails intuneDetails = default(ExternalStoreResponseIntuneDetails), string serviceConnectionId = default(string), string createdBy = default(string), string createdByPrincipalType = default(string))
        {
            this.Id = id;
            this.Name = name;
            this.Type = type;
        ...
        public ExternalStoreResponseIntuneDetails IntuneDetails { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ExternalStoreResponse {\n");
        ...
        {
            return this.Equals(input as ExternalStoreResponse);
        }

        /// <summary>
        /// Returns true if ExternalStoreResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of ExternalStoreResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ExternalStoreResponse input)
        {
            if (input == null)
                return false;
