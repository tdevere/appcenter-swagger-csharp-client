...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class ApiTokenResponse :  IEquatable<ApiTokenResponse>, IValidatableObject
    {
        /// <summary>
        /// Defines Scope
        /// </summary>
        ...
        public ApiTokenResponse(Guid? id = default(Guid?), string createdAt = default(string), List<ScopeEnum> scope = default(List<ScopeEnum>), string encryptedToken = default(string), string description = default(string))
        {
            // to ensure "id" is required (not null)
            if (id == null)
            {
                throw new InvalidDataException("id is a required property for ApiTokenResponse and cannot be null");
            }
            else
            {
                this.Id = id;
            ...
            if (createdAt == null)
            {
                throw new InvalidDataException("createdAt is a required property for ApiTokenResponse and cannot be null");
            }
            else
            {
        ...
        {
            return this.Equals(input as ApiTokenResponse);
        }

        /// <summary>
        /// Returns true if ApiTokenResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of ApiTokenResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ApiTokenResponse input)
        {
            if (input == null)
                return false;
