...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class V2MissingSymbolCrashGroupsResponseGroups :  IEquatable<V2MissingSymbolCrashGroupsResponseGroups>, IValidatableObject
    {
        /// <summary>
        /// group status
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="V2MissingSymbolCrashGroupsResponseGroups" /> class.
        /// </summary>
        ...
        public V2MissingSymbolCrashGroupsResponseGroups(string symbolGroupId = default(string), int? crashCount = default(int?), int? errorCount = default(int?), string appId = default(string), string appVer = default(string), string appBuild = default(string), DateTime? lastModified = default(DateTime?), List<V2MissingSymbolsInner> missingSymbols = default(List<V2MissingSymbolsInner>), StatusEnum status = default(StatusEnum))
        {
            // to ensure "symbolGroupId" is required (not null)
            if (symbolGroupId == null)
            {
                throw new InvalidDataException("symbolGroupId is a required property for V2MissingSymbolCrashGroupsResponseGroups and cannot be null");
            }
            else
            {
            ...
            if (appId == null)
            {
                throw new InvalidDataException("appId is a required property for V2MissingSymbolCrashGroupsResponseGroups and cannot be null");
            }
            else
            {
                this.AppId = appId;
            ...
            if (appVer == null)
            {
                throw new InvalidDataException("appVer is a required property for V2MissingSymbolCrashGroupsResponseGroups and cannot be null");
            }
            else
            {
                this.AppVer = appVer;
            ...
            if (appBuild == null)
            {
                throw new InvalidDataException("appBuild is a required property for V2MissingSymbolCrashGroupsResponseGroups and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("lastModified is a required property for V2MissingSymbolCrashGroupsResponseGroups and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("missingSymbols is a required property for V2MissingSymbolCrashGroupsResponseGroups and cannot be null");
            }
            else
            {
            ...
            if (status == null)
            {
                throw new InvalidDataException("status is a required property for V2MissingSymbolCrashGroupsResponseGroups and cannot be null");
            }
            else
            {
                this.Status = status;
        ...
        public List<V2MissingSymbolsInner> MissingSymbols { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class V2MissingSymbolCrashGroupsResponseGroups {\n");
        ...
        {
            return this.Equals(input as V2MissingSymbolCrashGroupsResponseGroups);
        }

        /// <summary>
        /// Returns true if V2MissingSymbolCrashGroupsResponseGroups instances are equal
        /// </summary>
        /// <param name="input">Instance of V2MissingSymbolCrashGroupsResponseGroups to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(V2MissingSymbolCrashGroupsResponseGroups input)
        {
            if (input == null)
                return false;
