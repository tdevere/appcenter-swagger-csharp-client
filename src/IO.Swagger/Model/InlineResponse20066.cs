...
namespace IO.Swagger.Model
{
        ...
        public partial class InlineResponse20066 :  IEquatable<InlineResponse20066>, IValidatableObject
    {
        ...
        public InlineResponse20066(string uri = default(string))
        {
            // to ensure "uri" is required (not null)
            if (uri == null)
            {
                throw new InvalidDataException("uri is a required property for InlineResponse20066 and cannot be null");
            }
            else
            {
                this.Uri = uri;
