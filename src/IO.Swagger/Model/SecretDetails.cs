...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class SecretDetails :  IEquatable<SecretDetails>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SecretDetails" /> class.
        /// </summary>
        ...
        public SecretDetails(string idToken = default(string), string refreshToken = default(string), string refreshTokenExpiry = default(string))
        {
        ...
        {
            return this.Equals(input as SecretDetails);
        }

        /// <summary>
        /// Returns true if SecretDetails instances are equal
        /// </summary>
        /// <param name="input">Instance of SecretDetails to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SecretDetails input)
        {
            if (input == null)
                return false;
