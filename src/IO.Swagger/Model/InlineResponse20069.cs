...
namespace IO.Swagger.Model
{
        ...
        public partial class InlineResponse20069 :  IEquatable<InlineResponse20069>, IValidatableObject
    {
        ...
        public InlineResponse20069(string appId = default(string), string crashGroupId = default(string), string crashId = default(string), int? crashesDeleted = default(int?), int? attachmentsDeleted = default(int?), int? blobsSucceeded = default(int?), int? blobsFailed = default(int?))
        {
            this.AppId = appId;
