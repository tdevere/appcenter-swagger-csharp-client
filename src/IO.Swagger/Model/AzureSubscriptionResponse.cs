...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class AzureSubscriptionResponse :  IEquatable<AzureSubscriptionResponse>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="AzureSubscriptionResponse" /> class.
        /// </summary>
        ...
        public AzureSubscriptionResponse(Guid? subscriptionId = default(Guid?), Guid? tenantId = default(Guid?), string subscriptionName = default(string), bool? isBilling = default(bool?), bool? isBillable = default(bool?), bool? isMicrosoftInternal = default(bool?))
        {
            // to ensure "subscriptionId" is required (not null)
            if (subscriptionId == null)
            {
                throw new InvalidDataException("subscriptionId is a required property for AzureSubscriptionResponse and cannot be null");
            }
            else
            {
            ...
            if (tenantId == null)
            {
                throw new InvalidDataException("tenantId is a required property for AzureSubscriptionResponse and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("subscriptionName is a required property for AzureSubscriptionResponse and cannot be null");
            }
            else
            {
        ...
        {
            return this.Equals(input as AzureSubscriptionResponse);
        }

        /// <summary>
        /// Returns true if AzureSubscriptionResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of AzureSubscriptionResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AzureSubscriptionResponse input)
        {
            if (input == null)
                return false;
