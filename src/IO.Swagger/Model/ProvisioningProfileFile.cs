...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class ProvisioningProfileFile :  IEquatable<ProvisioningProfileFile>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ProvisioningProfileFile" /> class.
        /// </summary>
        ...
        public ProvisioningProfileFile(string fileName = default(string), string fileId = default(string), string uploadId = default(string), string targetBundleIdentifier = default(string))
        {
        ...
        {
            return this.Equals(input as ProvisioningProfileFile);
        }

        /// <summary>
        /// Returns true if ProvisioningProfileFile instances are equal
        /// </summary>
        /// <param name="input">Instance of ProvisioningProfileFile to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ProvisioningProfileFile input)
        {
            if (input == null)
                return false;
