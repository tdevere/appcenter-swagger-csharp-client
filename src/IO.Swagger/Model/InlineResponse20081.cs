...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class InlineResponse20081 :  IEquatable<InlineResponse20081>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse20081" /> class.
        /// </summary>
        ...
        public InlineResponse20081(bool? exceededMaxLimit = default(bool?), DateTime? lastReceivedLogTimestamp = default(DateTime?), List<LogFlowLogContainerLogs> logs = default(List<LogFlowLogContainerLogs>))
        {
            // to ensure "logs" is required (not null)
            if (logs == null)
            {
                throw new InvalidDataException("logs is a required property for InlineResponse20081 and cannot be null");
            }
            else
            {
                this.Logs = logs;
        ...
        {
            return this.Equals(input as InlineResponse20081);
        }

        /// <summary>
        /// Returns true if InlineResponse20081 instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponse20081 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse20081 input)
        {
            if (input == null)
                return false;
