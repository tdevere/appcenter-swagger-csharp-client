...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class XcodeBranchConfigurationProperties :  IEquatable<XcodeBranchConfigurationProperties>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="XcodeBranchConfigurationProperties" /> class.
        /// </summary>
        ...
        {
            return this.Equals(input as XcodeBranchConfigurationProperties);
        }

        /// <summary>
        /// Returns true if XcodeBranchConfigurationProperties instances are equal
        /// </summary>
        /// <param name="input">Instance of XcodeBranchConfigurationProperties to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(XcodeBranchConfigurationProperties input)
        {
            if (input == null)
                return false;
