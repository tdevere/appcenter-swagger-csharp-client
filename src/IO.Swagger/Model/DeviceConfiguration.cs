...
namespace IO.Swagger.Model
{
        ...
        public partial class DeviceConfiguration :  IEquatable<DeviceConfiguration>, IValidatableObject
    {
        ...
        public DeviceConfiguration(string name = default(string), Guid? id = default(Guid?), decimal? tier = default(decimal?), V01appsownerNameappNamedeviceConfigurationsImage image = default(V01appsownerNameappNamedeviceConfigurationsImage), DeviceConfigurationModel model = default(DeviceConfigurationModel), string os = default(string), string osName = default(string), decimal? marketShare = default(decimal?))
        {
            this.Name = name;
            this.Id = id;
            this.Tier = tier;
        ...
        public DeviceConfigurationModel Model { get; set; }
