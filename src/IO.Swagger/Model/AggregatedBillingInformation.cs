...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class AggregatedBillingInformation :  IEquatable<AggregatedBillingInformation>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="AggregatedBillingInformation" /> class.
        /// </summary>
        ...
        public AggregatedBillingInformation(string version = default(string), string timestamp = default(string), string id = default(string), AggregatedBillingInformationBillingPlans billingPlans = default(AggregatedBillingInformationBillingPlans), AggregatedBillingInformationUsage usage = default(AggregatedBillingInformationUsage), string azureSubscriptionId = default(string), AzureSubscriptionStateEnum? azureSubscriptionState = default(AzureSubscriptionStateEnum?))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class AggregatedBillingInformation {\n");
        ...
        {
            return this.Equals(input as AggregatedBillingInformation);
        }

        /// <summary>
        /// Returns true if AggregatedBillingInformation instances are equal
        /// </summary>
        /// <param name="input">Instance of AggregatedBillingInformation to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AggregatedBillingInformation input)
        {
            if (input == null)
                return false;
