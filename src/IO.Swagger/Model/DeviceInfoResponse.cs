...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class DeviceInfoResponse :  IEquatable<DeviceInfoResponse>, IValidatableObject
    {
        /// <summary>
        ...
        public DeviceInfoResponse(string udid = default(string), string model = default(string), string deviceName = default(string), string fullDeviceName = default(string), string osBuild = default(string), string osVersion = default(string), string serial = default(string), string imei = default(string), string ownerId = default(string), string status = default(string), string registeredAt = default(string))
        {
            // to ensure "udid" is required (not null)
            if (udid == null)
            {
                throw new InvalidDataException("udid is a required property for DeviceInfoResponse and cannot be null");
            }
            else
            {
                this.Udid = udid;
            ...
            if (model == null)
            {
                throw new InvalidDataException("model is a required property for DeviceInfoResponse and cannot be null");
            }
            else
            {
                this.Model = model;
            ...
            if (deviceName == null)
            {
                throw new InvalidDataException("deviceName is a required property for DeviceInfoResponse and cannot be null");
            }
            else
            {
            ...
            if (osBuild == null)
            {
                throw new InvalidDataException("osBuild is a required property for DeviceInfoResponse and cannot be null");
            }
            else
            {
            ...
            if (osVersion == null)
            {
                throw new InvalidDataException("osVersion is a required property for DeviceInfoResponse and cannot be null");
            }
            else
            {
            ...
            if (status == null)
            {
                throw new InvalidDataException("status is a required property for DeviceInfoResponse and cannot be null");
            }
            else
            {
                this.Status = status;
        ...
        {
            return this.Equals(input as DeviceInfoResponse);
        }

        /// <summary>
        /// Returns true if DeviceInfoResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of DeviceInfoResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(DeviceInfoResponse input)
        {
            if (input == null)
                return false;
