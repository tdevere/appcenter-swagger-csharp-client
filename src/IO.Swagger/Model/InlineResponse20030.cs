...
namespace IO.Swagger.Model
{
        ...
        public partial class InlineResponse20030 :  IEquatable<InlineResponse20030>, IValidatableObject
    {
        ...
        public InlineResponse20030(string symbolUploadId = default(string), string appId = default(string), V01appsownerNameappNamesymbolUploadsUser user = default(V01appsownerNameappNamesymbolUploadsUser), StatusEnum status = default(StatusEnum), SymbolTypeEnum symbolType = default(SymbolTypeEnum), List<V01appsownerNameappNamesymbolUploadsSymbolsUploaded> symbolsUploaded = default(List<V01appsownerNameappNamesymbolUploadsSymbolsUploaded>), OriginEnum? origin = default(OriginEnum?), string fileName = default(string), decimal? fileSize = default(decimal?), DateTime? timestamp = default(DateTime?))
        {
            // to ensure "symbolUploadId" is required (not null)
            if (symbolUploadId == null)
            {
                throw new InvalidDataException("symbolUploadId is a required property for InlineResponse20030 and cannot be null");
            }
            else
            {
            ...
            if (appId == null)
            {
                throw new InvalidDataException("appId is a required property for InlineResponse20030 and cannot be null");
            }
            else
            {
                this.AppId = appId;
            ...
            if (status == null)
            {
                throw new InvalidDataException("status is a required property for InlineResponse20030 and cannot be null");
            }
            else
            {
                this.Status = status;
            ...
            if (symbolType == null)
            {
                throw new InvalidDataException("symbolType is a required property for InlineResponse20030 and cannot be null");
            }
            else
            {
