...
namespace IO.Swagger.Model
{
    ...
    [JsonConverter(typeof(JsonSubtypes), "type")]
        public partial class ExportConfigurationsExportConfigurationIdBody :  IEquatable<ExportConfigurationsExportConfigurationIdBody>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="ExportConfigurationsExportConfigurationIdBody" /> class.
        /// </summary>
        ...
        public ExportConfigurationsExportConfigurationIdBody(TypeEnum type = default(TypeEnum), List<ExportEntitiesEnum> exportEntities = default(List<ExportEntitiesEnum>), string resourceName = default(string), string resourceGroup = default(string), bool? backfill = default(bool?))
        {
            // to ensure "type" is required (not null)
            if (type == null)
            {
                throw new InvalidDataException("type is a required property for ExportConfigurationsExportConfigurationIdBody and cannot be null");
            }
            else
            {
                this.Type = type;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ExportConfigurationsExportConfigurationIdBody {\n");
        ...
        {
            return this.Equals(input as ExportConfigurationsExportConfigurationIdBody);
        }

        /// <summary>
        /// Returns true if ExportConfigurationsExportConfigurationIdBody instances are equal
        /// </summary>
        /// <param name="input">Instance of ExportConfigurationsExportConfigurationIdBody to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ExportConfigurationsExportConfigurationIdBody input)
        {
            if (input == null)
                return false;
