...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class CrashGroupLanguage :  IEquatable<CrashGroupLanguage>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CrashGroupLanguage" /> class.
        /// </summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CrashGroupLanguage {\n");
        ...
        {
            return this.Equals(input as CrashGroupLanguage);
        }

        /// <summary>
        /// Returns true if CrashGroupLanguage instances are equal
        /// </summary>
        /// <param name="input">Instance of CrashGroupLanguage to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CrashGroupLanguage input)
        {
            if (input == null)
                return false;
