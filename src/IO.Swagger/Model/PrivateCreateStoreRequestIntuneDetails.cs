...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class PrivateCreateStoreRequestIntuneDetails :  IEquatable<PrivateCreateStoreRequestIntuneDetails>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PrivateCreateStoreRequestIntuneDetails" /> class.
        /// </summary>
        ...
        public PrivateCreateStoreRequestIntuneDetails(V01appsownerNameappNamedistributionStoresIntuneDetails1TargetAudience targetAudience = default(V01appsownerNameappNamedistributionStoresIntuneDetails1TargetAudience), V01appsownerNameappNamedistributionStoresIntuneDetails1AppCategory appCategory = default(V01appsownerNameappNamedistributionStoresIntuneDetails1AppCategory), string tenantId = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class PrivateCreateStoreRequestIntuneDetails {\n");
        ...
        {
            return this.Equals(input as PrivateCreateStoreRequestIntuneDetails);
        }

        /// <summary>
        /// Returns true if PrivateCreateStoreRequestIntuneDetails instances are equal
        /// </summary>
        /// <param name="input">Instance of PrivateCreateStoreRequestIntuneDetails to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PrivateCreateStoreRequestIntuneDetails input)
        {
            if (input == null)
                return false;
