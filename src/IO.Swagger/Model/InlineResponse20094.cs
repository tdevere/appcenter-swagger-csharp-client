...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class InlineResponse20094 :  IEquatable<InlineResponse20094>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse20094" /> class.
        /// </summary>
        /// <param name="crashCount">crashCount.</param>
        /// <param name="models">models.</param>
        public InlineResponse20094(long? crashCount = default(long?), List<CrashGroupModelsModels> models = default(List<CrashGroupModelsModels>))
        {
        ...
        {
            return this.Equals(input as InlineResponse20094);
        }

        /// <summary>
        /// Returns true if InlineResponse20094 instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponse20094 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse20094 input)
        {
            if (input == null)
                return false;
