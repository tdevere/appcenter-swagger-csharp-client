...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class LegacyDeploymentHistory :  IEquatable<LegacyDeploymentHistory>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="LegacyDeploymentHistory" /> class.
        /// </summary>
        ...
        public LegacyDeploymentHistory(LegacyDeploymentsResponsePackage allOf = default(LegacyDeploymentsResponsePackage), string description = default(string), string originalDeployment = default(string), string originalLabel = default(string), string packageHash = default(string))
        {
            this.AllOf = allOf;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class LegacyDeploymentHistory {\n");
        ...
        {
            return this.Equals(input as LegacyDeploymentHistory);
        }

        /// <summary>
        /// Returns true if LegacyDeploymentHistory instances are equal
        /// </summary>
        /// <param name="input">Instance of LegacyDeploymentHistory to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(LegacyDeploymentHistory input)
        {
            if (input == null)
                return false;
